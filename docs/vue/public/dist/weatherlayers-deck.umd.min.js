...
!(function (t, e) {
    ...
    : e(
        ((t =
          "undefined" != typeof globalThis
            ? globalThis
            : t || self).WeatherLayers = {}),
        t.deck,
        t.deck,
        t.deck,
        t.luma
      );
})(this, function (t, e, n, r, a) {
  "use strict";
  const i = new Map();
  const o = { INWARD: "INWARD", OUTWARD: "OUTWARD" },
    s = {
      VALUE: "VALUE",
      CARDINAL: "CARDINAL",
      CARDINAL2: "CARDINAL2",
    ...
    A = {
      [s.CARDINAL]: ["N", "E", "S", "W"],
      [s.CARDINAL2]: ["N", "NE", "E", "SE", "S", "SW", "W", "NW"],
      [s.CARDINAL3]: [
        "N",
        "NNE",
        "NE",
  ...
  function l(t, e) {
    ...
    const { scale: n = 1, offset: r = 0, decimals: a = 0 } = e,
      i = n * t + r;
    return `${a ? Math.round(i * 10 ** a) / 10 ** a : Math.round(i)}`;
  }
  function c(t) {
    return t.unit.replace("^2", "²").replace("^3", "³");
  }
  function u(t, e) {
    return `${l(t, e)} ${c(e)}`;
  }
  function g(t, e, n) {
    if ((e === o.OUTWARD && (t += 180), n === s.VALUE))
      return `${Math.round(t % 360)}°`;
    if (n === s.CARDINAL || n === s.CARDINAL2 || n === s.CARDINAL3) {
      const e = A[n],
        r = 360 / e.length;
      return e[Math.floor(((t % 360) + r / 2) / r) % e.length];
    }
  ...
  function v(t, e) {
    const n = {};
    for (const r in t)
      if (void 0 === t[r] && r in e) {
        const t = e[r];
        t && ("value" in t ? t.value && (n[r] = t.value) : (n[r] = t));
      }
  ...
  class I {
    ...
    updateConfig(t) {
      this.setConfig({ ...this._config, ...t });
    }
    get running() {
      return this._running;
    }
    toggle(t = !this._running) {
    ...
    stop() {
      this._running &&
        ((this._running = !1),
        this._raf &&
          (window.cancelAnimationFrame(this._raf), (this._raf = void 0)));
    }
    step() {
      const t = 1e3 / (this._config.fps ?? 30),
        e = Date.now(),
        n = e - this._lastFrameTime;
      n > t && ((this._lastFrameTime = e - (n % t)), this._config.onUpdate()),
        this._running &&
          (this._raf = window.requestAnimationFrame(() => this.step()));
    }
  }
  ...
  async function b(t, e) {
    const n = await (async function (t) {
      ...
      try {
        if ("geotiff" === t) return await import("geotiff");
      } catch (e) {
        throw new Error(
          `Optional dependency '${t}' is missing, install it with a package manager or provide with \`setLibrary('${t}', library)\``,
          { cause: e }
        );
      }
    })("geotiff");
    ...
    try {
      r = await n.fromUrl(
        t,
        {
          ...
          fetch: (t, n) =>
            fetch(t, { ...n, headers: { ...n?.headers, ...e?.headers } }),
        },
        e?.signal
      );
    } catch (e) {
      throw new Error(`Image ${t} can't be decoded.`, { cause: e });
    }
    const a = await r.getImage(0),
      o = await a.readRasters({ interleave: !0, signal: e?.signal });
    if (
      !(
    ...
    const s = (function (t, e) {
      ...
      for (let t = 0; t < n.length; t++)
        Math.abs(n[t] - e) < 2 * Number.EPSILON && (n[t] = NaN);
      return n;
    })(o, a.getGDALNoData());
    return { data: s, width: a.getWidth(), height: a.getHeight() };
  }
  function B(t) {
    return async (e, n) => {
      if (!1 === n?.cache) return t(e);
      const r = n?.cache ?? E,
        a = e + (n?.headers ? ":" + JSON.stringify(n?.headers) : ""),
        i = r.get(a);
      if (i) return i;
      const o = { ...n, cache: void 0 },
        s = t(e, o);
      return (
        r.set(a, s),
        s.then((t) => {
  ...
  const w = B(async (t, e) => {
      if (
        ...
        return (async function (t, e) {
          let n;
          if (e?.headers || e?.signal) {
            const r = await fetch(t, { headers: e.headers, signal: e.signal });
            if (!r.ok)
              throw new Error(`URL ${t} can't be loaded. Status: ${r.status}`);
          ...
          try {
            ...
            throw new Error(`URL ${t} can't be loaded.`, { cause: e });
          } finally {
            n && URL.revokeObjectURL(n);
          }
          try {
            await y.run(() => r.decode());
          } catch (e) {
            throw new Error(`Image ${t} can't be decoded.`, { cause: e });
          }
          ...
          const o = i.getImageData(0, 0, a.width, a.height),
            { data: s, width: A, height: l } = o;
          return { data: s, width: A, height: l };
        })(t, e);
      if (t.includes(".tif") || t.includes("image/tif")) return b(t, e);
      throw new Error("Unsupported data format");
    }),
    Q = B(async (t, e) => {
      const n = await fetch(t, { headers: e?.headers });
      if (!n.ok)
        throw new Error(`URL ${t} can't be loaded. Status: ${n.status}`);
      return n.json();
    });
  function x(t, e, n) {
    if (!e) {
    ...
    if (n >= 1) return e;
    {
      const r = new Date(t),
        a = new Date(e);
      return new Date(
        r.getTime() + (a.getTime() - r.getTime()) * n
      ).toISOString();
    }
  }
  function T(t, e, n) {
    ...
    if (n >= e) return 1;
    {
      const r = new Date(t),
        a = new Date(e);
      return (
        (new Date(n).getTime() - r.getTime()) / (a.getTime() - r.getTime())
      );
    }
  }
  function M(t, e) {
    const n = new Date(t);
    return new Date(n.getTime() + 1e3 * e * 60 * 60).toISOString();
  }
  function O(t) {
    if (!t) return t;
    const e = new Date(t);
    if (!e.getDate()) return t;
    return `${e.getUTCFullYear()}/${`${e.getUTCMonth() + 1}`.padStart(2, "0")}/${`${e.getUTCDate()}`.padStart(2, "0")} ${`${e.getUTCHours()}`.padStart(2, "0")}:${`${e.getUTCMinutes()}`.padStart(2, "0")} UTC`;
  }
  const S = { NEAREST: "NEAREST", LINEAR: "LINEAR", CUBIC: "CUBIC" },
    P = { SCALAR: "SCALAR", VECTOR: "VECTOR" };
  function L(t) {
    return t &&
      t.__esModule &&
  ...
  var N, U, D, V, F, k, J, R, Z, q, W, G, z, K, j, X, Y, _;
  function H() {
    return U
      ? N
      : ((U = 1), (N = (t, e = 0, n = 1) => (t < e ? e : t > n ? n : t)));
  }
  function $() {
    if (V) return D;
    V = 1;
  ...
  function nt() {
    ...
    return (Z = (e) => {
      ...
      const n = e.length - 1;
      return "string" == t(e[n]) ? e[n].toLowerCase() : null;
    });
  }
  function rt() {
    if (G) return W;
  ...
  function at() {
    return K ? z : ((K = 1), (z = { format: {}, autodetect: [] }));
  }
  function it() {
    if (X) return j;
    X = 1;
    const { last: t, clip_rgb: e, type: n } = rt(),
      r = at();
    return (
      (j = class {
        constructor(...a) {
          ...
          if (
            "object" === n(a[0]) &&
            a[0].constructor &&
            a[0].constructor === this.constructor
          )
            return a[0];
          let o = t(a),
            s = !1;
          if (!o) {
            (s = !0),
              r.sorted ||
                ((r.autodetect = r.autodetect.sort((t, e) => e.p - t.p)),
                (r.sorted = !0));
            for (let t of r.autodetect) if (((o = t.test(...a)), o)) break;
          }
          if (!r.format[o]) throw new Error("unknown format: " + a);
          {
            const t = r.format[o].apply(null, s ? a : a.slice(0, -1));
            i._rgb = e(t);
          }
          3 === i._rgb.length && i._rgb.push(1);
        }
        toString() {
          return "function" == n(this.hex)
            ? this.hex()
            : `[${this._rgb.join(",")}]`;
        }
      }),
  ...
  function ot() {
    if (_) return Y;
    _ = 1;
    const t = (...e) => new t.Color(...e);
    return (t.Color = it()), (t.version = "@@version"), (Y = t);
  }
  var st,
    At,
    lt,
  ...
  function It() {
    ...
    return (lt = (...e) => {
      ...
      return (
        ...
        (l *= 60),
        l < 0 && (l += 360),
        e.length > 3 && void 0 !== e[3] ? [l, A, s, e[3]] : [l, A, s]
      );
    });
  }
  function Et() {
    if (gt) return ut;
    gt = 1;
    const { unpack: t, last: e } = rt(),
      n = (function () {
        if (At) return st;
        At = 1;
        const { unpack: t, last: e } = rt(),
          n = (t) => Math.round(100 * t) / 100;
        return (st = (...r) => {
          const a = t(r, "hsla");
          let i = e(r) || "lsa";
          return (
            ...
            (a[1] = n(100 * a[1]) + "%"),
            (a[2] = n(100 * a[2]) + "%"),
            "hsla" === i || (a.length > 3 && a[3] < 1)
              ? ((a[3] = a.length > 3 ? a[3] : 1), (i = "hsla"))
              : (a.length = 3),
            `${i}(${a.join(",")})`
          );
        });
    ...
    return (ut = (...i) => {
      ...
      return "hsl" == s.substr(0, 3)
        ...
        : ((o[0] = a(o[0])),
          (o[1] = a(o[1])),
          (o[2] = a(o[2])),
          ("rgba" === s || (o.length > 3 && o[3] < 1)) &&
            ((o[3] = o.length > 3 ? o[3] : 1), (s = "rgba")),
          `${s}(${o.slice(0, "rgb" === s ? 3 : 4).join(",")})`);
    });
  }
  function yt() {
    if (pt) return dt;
    ...
    return (dt = (...n) => {
      ...
      if (0 === a) o = s = A = 255 * i;
        ...
        const t = [0, 0, 0],
          n = [0, 0, 0],
          l = i < 0.5 ? i * (1 + a) : i + a - i * a,
          c = 2 * i - l,
          u = r / 360;
        (t[0] = u + 1 / 3), (t[1] = u), (t[2] = u - 1 / 3);
        for (let e = 0; e < 3; e++)
          t[e] < 0 && (t[e] += 1),
            t[e] > 1 && (t[e] -= 1),
            6 * t[e] < 1
              ...
              ? (n[e] = c + (l - c) * (2 / 3 - t[e]) * 6)
              : (n[e] = c);
        [o, s, A] = [e(255 * n[0]), e(255 * n[1]), e(255 * n[2])];
      }
      return n.length > 3 ? [o, s, A, n[3]] : [o, s, A, 1];
    });
  }
  !(function () {
    if (mt) return vt;
    ...
    const t = ot(),
      ...
      i = (function () {
        ...
        const t = yt(),
          ...
          l = (l) => {
            let c;
            if (((l = l.toLowerCase().trim()), e.format.named))
              try {
                return e.format.named(l);
              } catch (t) {}
            if ((c = l.match(n))) {
              const t = c.slice(1, 4);
              for (let e = 0; e < 3; e++) t[e] = +t[e];
              return (t[3] = 1), t;
            }
            if ((c = l.match(r))) {
              const t = c.slice(1, 5);
              for (let e = 0; e < 4; e++) t[e] = +t[e];
              return t;
            }
            if ((c = l.match(a))) {
              const t = c.slice(1, 4);
              for (let e = 0; e < 3; e++) t[e] = A(2.55 * t[e]);
              return (t[3] = 1), t;
            }
            if ((c = l.match(i))) {
              const t = c.slice(1, 5);
    ...
    (e.prototype.css = function (t) {
      ...
      n.autodetect.push({
        p: 5,
        test: (t, ...e) => {
          if (!e.length && "string" === r(t) && i.test(t)) return "css";
        },
      });
  })();
  var bt,
  ...
  function Mt() {
    ...
    const { unpack: t, last: e } = rt(),
      { round: n } = Math;
    return (bt = (...r) => {
      let [a, i, o, s] = t(r, "rgba"),
        A = e(r) || "auto";
      void 0 === s && (s = 1),
        "auto" === A && (A = s < 1 ? "rgba" : "rgb"),
        (a = n(a)),
        (i = n(i)),
        (o = n(o));
      let l = "000000" + ((a << 16) | (i << 8) | o).toString(16);
      l = l.substr(l.length - 6);
      let c = "0" + n(255 * s).toString(16);
  ...
  function Ot() {
    if (Qt) return wt;
    Qt = 1;
    const t = /^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,
      e = /^#?([A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/;
    return (
      (wt = (n) => {
        if (n.match(t)) {
        ...
        if (n.match(e)) {
          (5 !== n.length && 9 !== n.length) || (n = n.substr(1)),
            4 === n.length &&
              (n =
                (n = n.split(""))[0] +
                n[0] +
  ...
  function Lt() {
    ...
    return (
      ...
      a.autodetect.push({
        p: 2,
        test: (...n) => {
          if (((n = t(n, "hsl")), "array" === e(n) && 3 === n.length))
            return "hsl";
        },
      }),
      Pt
    ...
    return (
      ...
      (a.format.hsv = (function () {
        ...
        return (Dt = (...n) => {
          ...
          return [r, a, i, n.length > 3 ? n[3] : 1];
        });
      })()),
      a.autodetect.push({
        p: 2,
        test: (...n) => {
          if (((n = t(n, "hsv")), "array" === e(n) && 3 === n.length))
            return "hsv";
        },
      }),
      kt
  ...
  !(function () {
    ...
    (t.prototype.name = function () {
      const t = i(this._rgb, "rgb");
      for (let e of Object.keys(r)) if (r[e] === t) return e.toLowerCase();
      return t;
    }),
      (e.format.named = (t) => {
        if (((t = t.toLowerCase()), r[t])) return a(r[t]);
        throw new Error("unknown color name: " + t);
      }),
      e.autodetect.push({
        p: 5,
        test: (t, ...e) => {
          if (!e.length && "string" === n(t) && r[t.toLowerCase()])
            return "named";
        },
      });
  })();
  ...
  !(function () {
    ...
    const t = ot(),
      ...
      { unpack: r, type: a } = rt(),
      { round: i } = Math;
    (e.prototype.rgb = function (t = !0) {
      return !1 === t ? this._rgb.slice(0, 3) : this._rgb.slice(0, 3).map(i);
    }),
      (e.prototype.rgba = function (t = !0) {
        return this._rgb
          .slice(0, 4)
          .map((e, n) => (n < 3 ? (!1 === t ? e : i(e)) : e));
      }),
      (t.rgb = (...t) => new e(...t, "rgb")),
      (n.format.rgb = (...t) => {
        const e = r(t, "rgba");
    ...
    return (Xt = (e, n, r, a) => {
      ...
      return (
        "hsl" === a
          ...
          ? ((i = e.hsi()), (o = n.hsi()))
          : "lch" === a || "hcl" === a
          ? ((a = "hcl"), (i = e.hcl()), (o = n.hcl()))
          : "oklch" === a &&
            ((i = e.oklch().reverse()), (o = n.oklch().reverse())),
        ("h" !== a.substr(0, 1) && "oklch" !== a) ||
          (([s, l, u] = i), ([A, c, g] = o)),
        isNaN(s) || isNaN(A)
          ? isNaN(s)
            ? isNaN(A)
              ? (p = Number.NaN)
              : ((p = A), (1 != u && 0 != u) || "hsv" == a || (d = c))
            : ((p = s), (1 != g && 0 != g) || "hsv" == a || (d = l))
          : ((f =
              A > s && A - s > 180
                ? A - (s + 360)
                : A < s && s - A > 180
        ...
        void 0 === d && (d = l + r * (c - l)),
        (h = u + r * (g - u)),
        new t("oklch" === a ? [h, d, p] : [p, d, h], a)
      );
    });
  }
  function le() {
    return Ht ? _t : ((Ht = 1), (_t = {}));
  }
  !(function () {
    if (jt) return se;
    jt = 1;
    const t = it(),
      { type: e } = rt();
    t.prototype.alpha = function (n, r = !1) {
      return void 0 !== n && "number" === e(n)
        ? r
          ? ((this._rgb[3] = n), this)
          : new t([this._rgb[0], this._rgb[1], this._rgb[2], n], "rgb")
        : this._rgb[3];
    };
  })(),
    (function () {
  ...
  var ce,
    ...
    ge = (function () {
      ...
      const t = it(),
        { type: e } = rt(),
        n = le();
      return (ie = (r, a, i = 0.5, ...o) => {
        let s = o[0] || "lrgb";
        if ((n[s] || o.length || (s = Object.keys(n)[0]), !n[s]))
          throw new Error(`interpolation mode ${s} is not defined`);
        return (
          "object" !== e(r) && (r = new t(r)),
          "object" !== e(a) && (a = new t(a)),
          n[s](r, a, i).alpha(r.alpha() + i * (a.alpha() - r.alpha()))
        );
      });
    })(),
    de = L(ge);
  var pe = (function () {
      ...
      return (
        (ce = function (r) {
          ...
          const v = function (n) {
            if (
              ((n = n || ["#fff", "#000"]) &&
                "string" === e(n) &&
                t.brewer &&
                t.brewer[n.toLowerCase()] &&
                (n = t.brewer[n.toLowerCase()]),
              "array" === e(n))
            ) {
              1 === n.length && (n = [n[0], n[0]]), (n = n.slice(0));
              for (let e = 0; e < n.length; e++) n[e] = t(n[e]);
              A.length = 0;
              for (let t = 0; t < n.length; t++) A.push(t / (n.length - 1));
            }
            return b(), (u = n);
          };
          let I = (t) => t,
            E = (t) => t;
          const y = function (r, o) {
            let s, g;
            if ((null == o && (o = !1), isNaN(r) || null === r)) return i;
            if (o) g = r;
              ...
              g =
                ...
                (c.length - 2);
            } else g = p !== d ? (r - d) / (p - d) : 1;
            (g = E(g)),
              o || (g = I(g)),
              1 !== C && (g = n(g, C)),
              (g = l[0] + g * (1 - l[0] - l[1])),
              (g = Math.min(1, Math.max(0, g)));
            const h = Math.floor(1e4 * g);
            if (m && f[h]) s = f[h];
            else {
              if ("array" === e(u))
                for (let e = 0; e < A.length; e++) {
                  ...
                  if (g > n && g < A[e + 1]) {
                    (g = (g - n) / (A[e + 1] - n)),
                      (s = t.interpolate(u[e], u[e + 1], g, a));
                    break;
                  }
                }
              else "function" === e(u) && (s = u(g));
              m && (f[h] = s);
            }
            return s;
          };
          ...
          return (
            (B.classes = function (n) {
              if (null != n) {
                if ("array" === e(n)) (c = n), (s = [n[0], n[n.length - 1]]);
                else {
                  const e = t.analyze(s);
                  c = 0 === n ? [e.min, e.max] : t.limits(e, "e", n);
                }
                return B;
              }
              return c;
            ...
            (B.domain = function (t) {
              ...
              (d = t[0]), (p = t[t.length - 1]), (A = []);
              const e = u.length;
              if (t.length === e && d !== p)
                for (let e of Array.from(t)) A.push((e - d) / (p - d));
              else {
                for (let t = 0; t < e; t++) A.push(t / (e - 1));
                if (t.length > 2) {
                  const e = t.map((e, n) => n / (t.length - 1)),
                    n = t.map((t) => (t - d) / (p - d));
                  n.every((t, n) => e[n] === t) ||
                    (E = (t) => {
                      if (t <= 0 || t >= 1) return t;
                      let r = 0;
                      for (; t >= n[r + 1]; ) r++;
                      const a = (t - n[r]) / (n[r + 1] - n[r]);
                      return e[r] + a * (e[r + 1] - e[r]);
                    });
                }
              }
              return (s = [d, p]), B;
            ...
            (B.mode = function (t) {
              return arguments.length ? ((a = t), b(), B) : a;
            }),
            (B.range = function (t, e) {
              return v(t), B;
            }),
            (B.out = function (t) {
              return (g = t), B;
            ...
            (B.padding = function (t) {
              return null != t
                ? ("number" === e(t) && (t = [t, t]), (l = t), B)
                : l;
            }),
            (B.colors = function (e, n) {
              arguments.length < 2 && (n = "hex");
              let a = [];
              if (0 === arguments.length) a = u.slice(0);
              else if (1 === e) a = [B(0.5)];
              else if (e > 1) {
                const t = s[0],
                  n = s[1] - t;
                a = (function (t, e, n) {
                  let r = [],
                    a = t < e,
                    i = e;
                  for (let e = t; a ? e < i : e > i; a ? e++ : e--) r.push(e);
                  return r;
                })(0, e).map((r) => B(t + (r / (e - 1)) * n));
              } else {
                r = [];
                let t = [];
                if (c && c.length > 2)
                  for (
                    let e = 1, n = c.length, r = 1 <= n;
                    r ? e < n : e > n;
                    r ? e++ : e--
                  )
                    t.push(0.5 * (c[e - 1] + c[e]));
                else t = s;
                a = t.map((t) => B(t));
              }
              return t[n] && (a = a.map((t) => t[n]())), a;
            }),
            (B.cache = function (t) {
              return null != t ? ((m = t), B) : m;
            }),
            (B.gamma = function (t) {
              return null != t ? ((C = t), B) : C;
            }),
            (B.nodata = function (e) {
              return null != e ? ((i = t(e)), B) : i;
            }),
            B
          );
        }),
    ...
    he = L(pe);
  (Ct.mix = Ct.interpolate = de), (Ct.scale = he);
  const fe = /[ ,\t:]+/g,
    me = /[\-\/]/g;
  function Ce(t) {
    return t.startsWith("#");
  ...
  function Ie(t) {
    const e = t.trim().split("\n"),
      n = (function (t) {
        return t.some((t) => !Ce(t) && t.split(fe).length >= 8);
      })(e),
      r = (function (t) {
        return t.some(
          (t) =>
            !(Ce(t) || (!t.match(/\d+\-\d+\-\d+/) && !t.match(/\d+\/\d+\/\d+/)))
        );
      })(e),
      a = (function (t) {
        const e = t.find((t) => Ce(t) && t.includes("COLOR_MODEL = "));
        if (e) {
          const t = e.match(/COLOR_MODEL = ([a-zA-Z]+)/);
          if (t) return t[1].toLowerCase();
        }
      })(e),
      i = e.filter((t) => !!t && !t.startsWith("#")),
      o = [];
    for (let t of i) {
      const e = t.split(fe);
      n
        ? 8 === e.length || 9 === e.length
          ? (o.push([e[0], [e[1], e[2], e[3]]]),
            o.push([e[4], [e[5], e[6], e[7]]]))
          : (4 !== e.length && 5 !== e.length) ||
            o.push([e[0], [e[1], e[2], e[3]]])
        : r
        ? 4 === e.length || 5 === e.length
          ? (o.push([e[0], ve(e[1])]), o.push([e[2], ve(e[3])]))
          : (2 !== e.length && 3 !== e.length) || o.push([e[0], ve(e[1])])
        : 5 === e.length
        ? o.push([e[0], [e[1], e[2], e[3], e[4]]])
        : 4 === e.length
        ? o.push([e[0], [e[1], e[2], e[3]]])
        : 2 === e.length && o.push([e[0], e[1]]);
    }
    return { paletteArray: o, mode: a };
  }
  const Ee = "rgb";
  function ye(t, e) {
    if ("string" == typeof t) {
      if ("%" === t[t.length - 1]) {
        ...
        if (n < 0 || n > 1)
          throw new Error(`Invalid value for a percentage ${t}`);
        return e[0] + (e[1] - e[0]) * n;
      }
      return "N" === t
        ? null
        : "B" === t || "F" === t
  ...
  function be(t, e) {
    if (Array.isArray(t)) {
      if (4 === t.length)
        return {
          [e[0]]: parseFloat(t[0].toString()),
          [e[1]]: parseFloat(t[1].toString()),
          [e[2]]: parseFloat(t[2].toString()),
          a: parseFloat(t[3].toString()) / 255,
        };
      if (3 === t.length)
        return {
          [e[0]]: parseFloat(t[0].toString()),
    ...
    if ("string" == typeof t || "number" == typeof t)
      return t.toString().match(/^\d+$/) || "number" == typeof t
        ? {
            [e[0]]: parseFloat(t.toString()),
            [e[1]]: parseFloat(t.toString()),
            [e[2]]: parseFloat(t.toString()),
          }
        : t;
    throw new Error(`Invalid color ${t}`);
  }
  function Be(t, { bounds: e = [0, 1], mode: n = Ee } = {}) {
    const r = [],
      a = [];
    let i;
    for (let [o, s] of t) {
      const t = ye(o, e),
        A = be(s, n);
      null != t ? (r.push(A), a.push(t)) : null === t && (i = A);
    }
    let o = Ct.scale(r).domain(a).mode(n);
    return void 0 !== i && (o = o.nodata(i)), o;
  }
  function we(t, { bounds: e = [0, 1] } = {}) {
    if ("string" == typeof t)
      return (function (t, { bounds: e = [0, 1] } = {}) {
        const { paletteArray: n, mode: r } = Ie(t);
        return Be(n, { bounds: e, mode: r });
      })(t, { bounds: e });
    if (Array.isArray(t)) return Be(t, { bounds: e });
    throw new Error("Invalid format");
  }
  function Qe(t, { width: e = 256, height: n = 1 } = {}) {
    const r = t.colors(e, "css"),
    ...
    const i = a.getContext("2d");
    for (let t = 0; t < e; t++) (i.fillStyle = r[t]), i.fillRect(t, 0, 1, n);
    return a;
  }
  const xe = { BOTTOM: "BOTTOM", TOP: "TOP", RIGHT: "RIGHT", LEFT: "LEFT" };
  function Te(t) {
    return t % 1;
  }
  function Me(t, e) {
    return t.map((n, r) => t[r] + e[r]);
  }
  function Oe(t, e) {
    return t.map((n, r) => t[r] * e);
  }
  function Se(t, e) {
    return t.map((n, r) => t[r] * e[r]).reduce((t, e) => t + e);
  }
  function Pe(t, e, n) {
    return t === e ? t : t * (1 - n) + e * n;
  }
  function Le(t, e, n) {
    return t.map((r, a) => Pe(t[a], e[a], n));
  }
  function Ne(t, e) {
    return e ? t[3] >= 255 : !isNaN(t[0]);
  }
  function Ue(t, e, n) {
    return e === P.VECTOR
      ? n
        ? [Pe(n[0], n[1], t[0] / 255), Pe(n[0], n[1], t[1] / 255)]
        : [t[0], t[1]]
      : [NaN, NaN];
  }
  function De(t, e, n) {
    ...
    return (function (t, e, n) {
      return e === P.VECTOR ? 0 : n ? Pe(n[0], n[1], t[0] / 255) : t[0];
    })(t, e, n);
  }
  function Ve(t, e, n, r, a, i) {
    const { data: o, width: s, height: A } = t,
      l = o.length / (s * A),
      c = (n + a + 0.5) / e[0],
      u = (r + i + 0.5) / e[1],
      g = Math.max(0, Math.min(s - 1, Math.floor(c * s))),
      d = Math.max(0, Math.min(A - 1, Math.floor(u * A)));
    return new Array(l).fill(void 0).map((t, e) => o[(g + d * s) * l + e]);
  }
  const Fe = [3, -6, 0, 4].map((t) => t / 6),
    ke = [-1, 6, -12, 8].map((t) => t / 6);
  function Je(t) {
  ...
  function Re(t, e, n, r, a) {
    const i = Me(
      Me(
        Me(Oe(t, Se(ke, Je(a + 1))), Oe(e, Se(Fe, Je(a)))),
        Oe(n, Se(Fe, Je(1 - a)))
      ),
      Oe(r, Se(ke, Je(2 - a)))
    );
    return (
      (i[3] =
        t[3] > 0 && e[3] > 0 && n[3] > 0 && r[3] > 0
          ? Math.max(Math.max(Math.max(t[3], e[3]), n[3]), r[3])
          : 0),
      i
    );
  }
    ...
    return n === S.CUBIC
      ...
      ? (function (t, e, n, r) {
          const a = n * e[0] - 0.5,
            ...
            l = Te(i);
          return Le(
            Le(Ve(t, e, o, s, 0, 0), Ve(t, e, o, s, 1, 0), A),
            Le(Ve(t, e, o, s, 0, 1), Ve(t, e, o, s, 1, 1), A),
            l
          );
        })(t, e, r, a)
      : (function (t, e, n, r) {
          const a = n * e[0] - 0.5,
            i = r * e[1] - 0.5;
          return Ve(t, e, Math.round(a), Math.round(i), 0, 0);
        })(t, e, r, a);
  }
  function qe(t, e, n, r, a, i, o, s) {
    const A = i ? o + 0.5 / n[0] : Pe(0 + 0.5 / n[0], 1 - 0.5 / n[0], o),
      l = Pe(0 + 0.5 / n[1], 1 - 0.5 / n[1], s);
    if (e && a > 0) {
      return Le(Ze(t, n, r, A, l), Ze(e, n, r, A, l), a);
    }
    return Ze(t, n, r, A, l);
  }
  function We(t, e, n) {
    const r = 1 + Math.max(0, n);
    return [t / r, e / r];
  }
  const Ge = -180,
    ze = 180,
    ...
    je = 85.051129;
  function Xe(t, e) {
    let n = ((((t + 180) % (r = 360)) + r) % r) - 180;
    var r;
    return "number" == typeof e && n < e && (n += 360), n;
  }
  function Ye(t) {
    return t[2] - t[0] == 360;
  }
    ...
    const {
      ...
      m = n.map((t) => {
        if (
          ...
          return _e(t, { value: NaN });
        const n = p(t),
          i = n[0] / g,
          m = n[1] / d,
          C = qe(r, a, h, o, s, f, i, m);
        if (!Ne(C, l)) return _e(t, { value: NaN });
        const v = De(C, A, l);
        if (
          ("number" == typeof c && !isNaN(c) && v < c) ||
          ("number" == typeof u && !isNaN(u) && v > u)
        )
          return _e(t, { value: NaN });
        if (A === P.VECTOR) {
          const e = (function (t, e, n) {
            if (e === P.VECTOR) {
              const r = Ue(t, e, n);
              return (
                (360 - ((Math.atan2(r[1], r[0]) / Math.PI) * 180 + 180) - 270) %
                360
              );
            }
            return NaN;
          })(C, A, l);
          return _e(t, { value: v, direction: e });
        }
        return _e(t, { value: v });
      });
      ...
      i =
        ...
        (() => {
          const r = (function (t, e, n) {
              const { data: r, width: a, height: i } = e,
                o = r.length / (a * i);
              let s;
              if (r instanceof Uint8Array || r instanceof Uint8ClampedArray)
                if (4 === o) s = "rgba8unorm";
                else if (2 === o) s = "rg8unorm";
                else {
                  if (1 !== o) throw new Error("Unsupported data format");
                  s = "r8unorm";
                }
              else {
                if (!(r instanceof Float32Array))
                  throw new Error("Unsupported data format");
                if (!t.features.has("float32-renderable-webgl"))
              ...
              return {
                ...
                sampler: {
                  magFilter: "nearest",
                  minFilter: "nearest",
                  addressModeU: n ? "repeat" : "clamp-to-edge",
  ...
  function An(t, e) {
    if (
      ...
      (r = e),
      !(
        Math.abs(n[0] - r[0]) > Number.EPSILON ||
        Math.abs(n[1] - r[1]) > Number.EPSILON
      ))
    )
      return NaN;
    var n, r;
    const a = on(t[1]),
      i = on(e[1]),
      o = on(e[0] - t[0]),
      s = Math.cos(a) * Math.sin(i) - Math.sin(a) * Math.cos(i) * Math.cos(o),
      A = Math.sin(o) * Math.cos(i),
      l = sn(Math.atan2(A, s));
    return (l + 360) % 360;
  }
  const ln = 6370972;
  function cn(t, e) {
    return (function (t, e, n = an) {
      const r = n,
        a = on(t[1]),
        i = on(t[0]),
        o = on(e[1]),
        ...
        l =
          ...
          Math.cos(a) * Math.cos(o) * Math.sin(A / 2) * Math.sin(A / 2);
      return r * (2 * Math.atan2(Math.sqrt(l), Math.sqrt(1 - l)));
    })(t, e, ln);
  }
  function un(t, e, n) {
    return (function (t, e, n, r = an) {
      const a = e / r,
        i = on(n),
        o = on(t[1]),
        s = on(t[0]),
        A = Math.sin(o) * Math.cos(a) + Math.cos(o) * Math.sin(a) * Math.cos(i),
        l = Math.asin(A),
        c = Math.sin(i) * Math.sin(a) * Math.cos(o),
        u = Math.cos(a) - Math.sin(o) * A,
        g = s + Math.atan2(c, u),
        d = sn(l);
      return [sn(g), d];
    })(t, e, n, ln);
  ...
  function pn(t, e, n) {
    return !(null != e && t.zoom < e) && !(null != n && t.zoom > n);
  }
  function hn(t) {
  ...
  function fn(t) {
    const e = hn(t);
    return Math.max(
      cn(e, t.unproject([t.width / 2, 0])),
      cn(e, t.unproject([0, t.height / 2])),
      ...(t.width > t.height
        ? [
            cn(
              e,
              t.unproject([t.width / 2 - (t.height / 4) * 1, t.height / 2])
            ),
            cn(
              e,
              t.unproject([t.width / 2 - (t.height / 2) * 1, t.height / 2])
            ),
            cn(
              e,
              t.unproject([t.width / 2 - (t.height / 4) * 3, t.height / 2])
            ),
            cn(e, t.unproject([t.width / 2 - t.height, t.height / 2])),
          ]
        : [
            cn(e, t.unproject([t.width / 2, t.height / 2 - (t.width / 4) * 1])),
            cn(e, t.unproject([t.width / 2, t.height / 2 - (t.width / 2) * 1])),
            cn(e, t.unproject([t.width / 2, t.height / 2 - (t.width / 4) * 3])),
            cn(e, t.unproject([t.width / 2, t.height / 2 - t.width])),
          ])
    );
  }
  function mn(t) {
    return (function (t) {
      const e = t[2] - t[0] < 360 ? Xe(t[0]) : Ge,
        n = t[2] - t[0] < 360 ? Xe(t[2], e) : ze;
      return [e, Math.max(t[1], Ke), n, Math.min(t[3], je)];
    })(t.getBounds());
  }
  function Cn(t) {
    return gn(t) ? Math.log2(t.scale) : t.zoom;
  }
  function vn(t, e) {
    return e * (gn(t) ? -1 : 1);
  }
  ...
  function En(t, e) {
    ...
    return {
      paletteBounds: r,
      paletteTexture: t.createTexture({
        data: a,
        sampler: {
          magFilter: "linear",
          minFilter: "linear",
  ...
  function yn(t) {
    return [t[0] / 255, t[1] / 255, t[2] / 255, (t[3] ?? 255) / 255];
  }
  function bn(t) {
    return [t[0], t[1], t[2], 255 * t[3]];
  }
  const Bn =
      "uniform bitmap2Uniforms{vec4 A;bool B;float C;vec4 D;}bitmap2;const float E=512.;const float F=3.1415926536;const float G=E/F/2.;vec2 H(vec2 I){float J=I.x;float K=clamp(I.y,-89.9,89.9);return vec2(radians(J)+F,F+log(tan(F*0.25+radians(K)*0.5)))*G;}vec2 L(vec2 M){M/=G;return degrees(vec2(M.x-F,atan(exp(M.y-F))*2.-F*0.5));}vec4 N(vec3 O,float P){return mix(bitmap2.D,vec4(O,1.),P);}vec2 Q(vec2 R){return vec2((R.x-bitmap2.A[0])/(bitmap2.A[2]-bitmap2.A[0]),(R.y-bitmap2.A[3])/(bitmap2.A[1]-bitmap2.A[3]));}vec2 S(vec2 T,vec2 U){vec2 uv=T;if(bitmap2.C<-0.5){vec2 I=L(U);uv=Q(I);}else if(bitmap2.C>0.5){vec2 V=H(U);uv=Q(V);}return uv;}",
    wn = "A",
    Qn = "B",
    xn = "C",
    Tn = "D";
  ...
  function Ln(t) {
    ...
    return [
      (Pn * (e * Sn + Mn)) / (2 * Mn),
      (Pn * (Mn + Math.log(Math.tan(On + 0.5 * r)))) / (2 * Mn),
    ];
  }
  function Nn(t = {}) {
    const { LNGLAT: n, CARTESIAN: r, DEFAULT: a } = e.COORDINATE_SYSTEM;
    let { viewportGlobe: i, bounds: o, _imageCoordinateSystem: s } = t;
    if (
      !(function (t) {
      ...
      throw new Error(
        "_imageCoordinateSystem only supports rectangular bounds"
      );
    if (s !== a) {
      const t = i ? n : r;
      if (((s = s === n ? n : r), s === n && t === r))
        return { coordinateConversion: -1, bounds: o };
      if (s === r && t === n) {
        const t = Ln([o[0], o[1]]),
          e = Ln([o[2], o[3]]);
        return { coordinateConversion: 1, bounds: [t[0], t[1], e[0], e[1]] };
      }
    }
    return { coordinateConversion: 0, bounds: o };
  }
  const Un = {
      name: "bitmap2",
      vs: Bn,
      ...
      getUniforms: function (t = {}) {
        const { bounds: e, coordinateConversion: n } = Nn(t);
        return {
          [wn]: e,
          [Qn]: Ye(e) ? 1 : 0,
          [xn]: n,
          [Tn]: t.transparentColor ? yn(t.transparentColor) : [0, 0, 0, 0],
        };
      },
    },
    Dn =
      "uniform sampler2D W;uniform sampler2D X;uniform rasterUniforms{vec2 Y;float Z;float a;float b;float c;vec2 d;float e;float f;float g;float h;vec4 i;float j;float k;vec4 l;}raster;",
    Vn = "W",
    Fn = "X",
    kn = "Y",
    Jn = "Z",
  ...
  const $n = {
      ...
      getUniforms: function (t = {}) {
        return {
          ...
          [Fn]: t.imageTexture2,
          [kn]: t.imageTexture
            ? [t.imageTexture.width, t.imageTexture.height]
            : [0, 0],
          [Jn]: t.imageSmoothing ?? 0,
          [Rn]: Object.values(S).indexOf(t.imageInterpolation ?? S.NEAREST),
          [Zn]:
            t.imageTexture2 !== t.imageTexture && t.imageWeight
              ? t.imageWeight
              : 0,
          [qn]: Object.values(P).indexOf(t.imageType ?? P.SCALAR),
          [Wn]: t.imageUnscale ?? [0, 0],
          [Gn]: t.imageMinValue ?? Number.MIN_SAFE_INTEGER,
          [zn]: t.imageMaxValue ?? Number.MAX_SAFE_INTEGER,
          [Kn]: t.borderEnabled ? 1 : 0,
          [jn]: t.borderWidth ?? 0,
          [Xn]: t.borderColor ? yn(t.borderColor) : [0, 0, 0, 0],
          [Yn]: t.gridEnabled ? 1 : 0,
          [_n]: t.gridSize ?? 0,
          [Hn]: t.gridColor ? yn(t.gridColor) : [0, 0, 0, 0],
        };
      },
    },
    tr =
      "uniform sampler2D m;uniform paletteUniforms{vec2 n;vec4 o;}palette;float p(float min,float max,float q){return(q-min)/(max-min);}vec4 r(sampler2D m,vec2 n,vec4 o,float q){if(n[0]<n[1]){float s=p(n[0],n[1],q);return texture(m,vec2(s,0.));}else{return o;}}",
    er = "m",
    nr = "n",
    rr = "o";
  const ar = {
      ...
      vs: tr,
      fs: tr,
      uniformTypes: { [nr]: "vec2<f32>", [rr]: "vec4<f32>" },
      getUniforms: function (t = {}) {
        return {
          [er]: t.paletteTexture,
          [nr]: t.paletteBounds ?? [0, 0],
          [rr]: t.paletteColor ? yn(t.paletteColor) : [0, 0, 0, 0],
        };
      },
    },
    ir = {
      ...
      imageInterpolation: { type: "object", value: S.CUBIC },
      imageWeight: { type: "number", value: 0 },
      imageType: { type: "object", value: P.SCALAR },
  ...
  class or extends n.BitmapLayer {
    ...
    draw(t) {
      const { device: e, viewport: n } = this.context,
        ...
        { paletteTexture: w, paletteBounds: Q } = this.state;
      if (!a) return;
      const x = gn(n);
      r &&
        pn(n, f, m) &&
        (r.shaderInputs.setProps({
          ...
          [ar.name]: { paletteTexture: w ?? rn(e), paletteBounds: Q },
        }),
        r.setParameters({
          ...r.parameters,
          cullMode: "back",
    ...
    _updatePalette() {
      const { device: t } = this.context,
        { palette: e } = v(this.props, ir);
      if (!e)
        return void this.setState({
          paletteTexture: void 0,
          paletteBounds: void 0,
        });
      const n = we(e),
        { paletteBounds: r, paletteTexture: a } = En(t, n);
      this.setState({ paletteTexture: a, paletteBounds: r });
    }
    _getRasterMagnitudeValue(t, e) {
      return e[0] + (t[0] / 255) * (e[1] - e[0]);
    }
    _getRasterDirectionValue(t) {
      const { imageType: e } = v(this.props, ir);
      return e === P.VECTOR ? (t[1] / 255) * 360 : NaN;
    }
    getPickingInfo(t) {
      const e = super.getPickingInfo(t),
        { imageType: n } = v(this.props, ir),
        { paletteBounds: r } = this.state;
      if (!e.color) return e;
      let a;
      const i = this._getRasterMagnitudeValue(e.color, r ?? [0, 0]);
      if (n === P.VECTOR) {
        a = { value: i, direction: this._getRasterDirectionValue(e.color) };
      } else a = { value: i };
      return (e.raster = a), e;
    }
  }
  (or.layerName = "RasterBitmapLayer"), (or.defaultProps = ir);
  const sr = {
    ...or.defaultProps,
    imageTexture: void 0,
    imageTexture2: void 0,
    image: { type: "object", value: null },
    image2: { type: "object", value: null },
    bounds: { type: "array", value: [-180, -90, 180, 90], compare: !0 },
  };
  class Ar extends e.CompositeLayer {
    renderLayers() {
      const { device: t } = this.context,
        { props: n, imageTexture: r, imageTexture2: a } = this.state;
      return n && r
        ? [
            new or(
              this.props,
              this.getSubLayerProps({
                ...
                imageTexture: r,
                imageTexture2: a,
                _imageCoordinateSystem: e.COORDINATE_SYSTEM.LNGLAT,
                image: rn(t),
                image2: rn(t),
              })
            ),
    ...
    updateState(t) {
      const { image: e, image2: n, imageUnscale: r, bounds: a } = t.props;
      if (
        (super.updateState(t),
        e &&
          r &&
          !(
            e.data instanceof Uint8Array || e.data instanceof Uint8ClampedArray
          ))
      )
        throw new Error("imageUnscale can be applied to Uint8 data only");
      if (e !== t.oldProps.image || n !== t.oldProps.image2) {
        const { device: t } = this.context,
          { image: e, image2: n } = this.props,
          r = e ? en(t, e, Ye(a)) : null,
          i = n ? en(t, n, Ye(a)) : null;
        this.setState({ imageTexture: r, imageTexture2: i });
      }
      this.setState({ props: t.props });
    }
  }
  (Ar.layerName = "RasterLayer"), (Ar.defaultProps = sr);
  const lr = "uniform contourUniforms{float t;float u;float v;}contour;",
    cr = "t",
    ur = "u",
    gr = "v";
  const dr = {
      ...
      vs: lr,
      fs: lr,
      uniformTypes: { [cr]: "f32", [ur]: "f32", [gr]: "f32" },
      getUniforms: function (t = {}) {
        return { [cr]: t.interval, [ur]: t.majorInterval, [gr]: t.width };
      },
    },
    pr = {
      imageTexture: { type: "object", value: null },
      ...
      bounds: { type: "array", value: [-180, -90, 180, 90], compare: !0 },
      minZoom: { type: "object", value: null },
      maxZoom: { type: "object", value: 10 },
      palette: { type: "object", value: null },
      color: { type: "color", value: d },
      interval: { type: "number", value: 0 },
      majorInterval: { type: "number", value: 0 },
      width: { type: "number", value: 1 },
    };
  class hr extends n.BitmapLayer {
    getShaders() {
      const t = super.getShaders();
      return {
        ...t,
    ...
    draw(t) {
      const { device: e, viewport: n } = this.context,
        ...
        { paletteTexture: b, paletteBounds: B } = this.state;
      if (!a) return;
      const w = gn(n);
      r &&
        pn(n, f, m) &&
        (r.shaderInputs.setProps({
          ...
          [ar.name]: {
            paletteTexture: b ?? rn(e),
            paletteBounds: B,
            paletteColor: C,
          },
          [dr.name]: { interval: I, majorInterval: E, width: y },
        }),
        r.setParameters({
          ...r.parameters,
          cullMode: "back",
  ...
  (hr.layerName = "ContourBitmapLayer"), (hr.defaultProps = pr);
  const fr = {
    ...hr.defaultProps,
    imageTexture: void 0,
    imageTexture2: void 0,
  ...
  class mr extends e.CompositeLayer {
    renderLayers() {
      const { device: t } = this.context,
        { props: n, imageTexture: r, imageTexture2: a } = this.state;
      return n && r
  ...
  (mr.layerName = "ContourLayer"), (mr.defaultProps = fr);
  const Cr = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
  function vr(t = 20) {
    return new Array(t)
      .fill(void 0)
      .map(() => Cr.charAt(Math.floor(62 * Math.random())))
      .join("");
  }
  const Ir = Symbol("Comlink.proxy"),
    Er = Symbol("Comlink.endpoint"),
    yr = Symbol("Comlink.releaseProxy"),
    br = Symbol("Comlink.finalizer"),
    Br = Symbol("Comlink.thrown"),
    wr = (t) => ("object" == typeof t && null !== t) || "function" == typeof t,
    Qr = new Map([
      [
        "proxy",
        {
          canHandle: (t) => wr(t) && t[Ir],
          serialize(t) {
            const { port1: e, port2: n } = new MessageChannel();
            return xr(t, e), [n, [n]];
          },
          deserialize: (t) => (t.start(), Mr(t)),
        },
      ],
      [
        "throw",
        {
          canHandle: (t) => wr(t) && Br in t,
          serialize({ value: t }) {
            let e;
            return (
              (e =
  ...
  function xr(t, e = globalThis, n = ["*"]) {
    e.addEventListener("message", function r(a) {
      ...
      const { id: i, type: o, path: s } = Object.assign({ path: [] }, a.data),
        A = (a.data.argumentList || []).map(kr);
      let l;
      try {
        const e = s.slice(0, -1).reduce((t, e) => t[e], t),
          n = s.reduce((t, e) => t[e], t);
        switch (o) {
          case "GET":
            l = n;
            break;
          case "SET":
            (e[s.slice(-1)[0]] = kr(a.data.value)), (l = !0);
            break;
          case "APPLY":
            l = n.apply(e, A);
            break;
      ...
      Promise.resolve(l)
        .catch((t) => ({ value: t, [Br]: 0 }))
        .then((n) => {
          const [a, s] = Fr(n);
          e.postMessage(Object.assign(Object.assign({}, a), { id: i }), s),
            "RELEASE" === o &&
              (e.removeEventListener("message", r),
              Tr(e),
              br in t && "function" == typeof t[br] && t[br]());
        })
        .catch((t) => {
          const [n, r] = Fr({
          ...
          e.postMessage(Object.assign(Object.assign({}, n), { id: i }), r);
        });
    }),
      e.start && e.start();
  }
  ...
  function Sr(t) {
    return Jr(t, new Map(), { type: "RELEASE" }).then(() => {
      Tr(t);
    });
  }
  const Pr = new WeakMap(),
    Lr =
      ...
      new FinalizationRegistry((t) => {
        const e = (Pr.get(t) || 0) - 1;
        Pr.set(t, e), 0 === e && Sr(t);
      });
  function Nr(t, e, n = [], r = function () {}) {
    let a = !1;
    const i = new Proxy(r, {
      get(r, o) {
        if ((Or(a), o === yr))
      ...
      set(r, i, o) {
        ...
        return Jr(
          t,
          e,
          { type: "SET", path: [...n, i].map((t) => t.toString()), value: s },
          A
        ).then(kr);
      },
      apply(r, i, o) {
        ...
        if (s === Er) return Jr(t, e, { type: "ENDPOINT" }).then(kr);
        if ("bind" === s) return Nr(t, e, n.slice(0, -1));
        const [A, l] = Ur(o);
        return Jr(
          t,
          e,
          { type: "APPLY", path: n.map((t) => t.toString()), argumentList: A },
          l
        ).then(kr);
      },
      construct(r, i) {
    ...
    return (
      (function (t, e) {
        const n = (Pr.get(e) || 0) + 1;
        Pr.set(e, n), Lr && Lr.register(t, e, t);
      })(i, t),
      i
    );
  }
  ...
  function Fr(t) {
    for (const [e, n] of Qr)
      if (n.canHandle(t)) {
        const [r, a] = n.serialize(t);
        return [{ type: "HANDLER", name: e, value: r }, a];
      }
    return [{ type: "RAW", value: t }, Dr.get(t) || []];
  }
  function kr(t) {
    switch (t.type) {
      case "HANDLER":
        return Qr.get(t.name).deserialize(t.value);
      case "RAW":
        return t.value;
    }
  }
  function Jr(t, e, n, r) {
    return new Promise((a) => {
      ...
      e.set(i, a),
        t.start && t.start(),
        t.postMessage(Object.assign({ id: i }, n), r);
    });
  }
  const Rr = function (t) {
    ...
    Zr =
      ((Wr = function () {
        ...
        function A(e, n = globalThis, i = ["*"]) {
          n.addEventListener("message", function o(s) {
            ...
            let p;
            try {
              const n = g.slice(0, -1).reduce((t, e) => t[e], e),
                r = g.reduce((t, e) => t[e], e);
              switch (u) {
                case "GET":
                  p = r;
                  break;
                case "SET":
                  (n[g.slice(-1)[0]] = v(s.data.value)), (p = !0);
                  break;
                case "APPLY":
                  p = r.apply(n, d);
                  break;
            ...
            Promise.resolve(p)
              ...
              .then((t) => {
                const [a, i] = C(t);
                n.postMessage(
                  Object.assign(Object.assign({}, a), { id: c }),
                  i
                ),
                  "RELEASE" === u &&
              ...
              .catch((t) => {
                ...
                n.postMessage(
                  Object.assign(Object.assign({}, e), { id: c }),
                  r
                );
              });
          }),
        ...
        function u(t) {
          return I(t, new Map(), { type: "RELEASE" }).then(() => {
            l(t);
          });
        }
        const g = new WeakMap(),
        ...
        function p(t, r, a = [], i = function () {}) {
          ...
          const s = new Proxy(i, {
            ...
            apply(n, i, s) {
              ...
              if (A === e) return I(t, r, { type: "ENDPOINT" }).then(v);
              if ("bind" === A) return p(t, r, a.slice(0, -1));
              const [l, u] = h(s);
              return I(
                t,
                r,
        ...
        function C(t) {
          ...
          return [{ type: "RAW", value: t }, f.get(t) || []];
        }
        function v(t) {
          switch (t.type) {
            case "HANDLER":
        ...
        const w = { NEAREST: "NEAREST", LINEAR: "LINEAR", CUBIC: "CUBIC" },
          Q = { VECTOR: "VECTOR" };
        function x(t) {
          return t % 1;
        }
        ...
        function N(t, e, n) {
          if (e === Q.VECTOR) {
            const r = (function (t, e, n) {
              return e === Q.VECTOR
                ? n
                  ? [S(n[0], n[1], t[0] / 255), S(n[0], n[1], t[1] / 255)]
                  : [t[0], t[1]]
                : [NaN, NaN];
            })(t, e, n);
            return Math.hypot(r[0], r[1]);
          ...
          return (function (t, e, n) {
            return e === Q.VECTOR ? 0 : n ? S(n[0], n[1], t[0] / 255) : t[0];
          })(t, e, n);
        }
        ...
        const D = [3, -6, 0, 4].map((t) => t / 6),
          V = [-1, 6, -12, 8].map((t) => t / 6);
        function F(t) {
          return [t * t * t, t * t, t, 1];
        }
        function k(t, e, n, r, a) {
          const i = T(
            T(T(M(t, O(V, F(a + 1))), M(e, O(D, F(a)))), M(n, O(D, F(1 - a)))),
            M(r, O(V, F(2 - a)))
          );
          return (
            (i[3] =
          ...
          return n === w.CUBIC
            ...
            ? (function (t, e, n, r) {
                const a = n * e[0] - 0.5,
                  ...
                  l = x(i);
                return P(
                  P(U(t, e, o, s, 0, 0), U(t, e, o, s, 1, 0), A),
                  P(U(t, e, o, s, 0, 1), U(t, e, o, s, 1, 1), A),
                  l
                );
              })(t, e, r, a)
            : (function (t, e, n, r) {
                const a = n * e[0] - 0.5,
                  i = r * e[1] - 0.5;
                return U(t, e, Math.round(a), Math.round(i), 0, 0);
              })(t, e, r, a);
        }
        function R(t, e, n, r, a, i, o, s) {
          const A = i ? o + 0.5 / n[0] : S(0 + 0.5 / n[0], 1 - 0.5 / n[0], o),
            l = S(0 + 0.5 / n[1], 1 - 0.5 / n[1], s);
          return e && a > 0
            ? P(J(t, n, r, A, l), J(e, n, r, A, l), a)
            : J(t, n, r, A, l);
        }
        function Z(t, e) {
          const {
            ...
            f = new Float32Array(u * g);
          for (let t = 0; t < g; t++)
            for (let e = 0; e < u; e++) {
              const a = e + t * u,
                i = R(n, r, p, d, o, h, e / u, t / g);
              if (!L(i, A)) {
                f[a] = NaN;
                continue;
              }
              const m = N(i, s, A);
              ("number" == typeof l && !isNaN(l) && m < l) ||
              ("number" == typeof c && !isNaN(c) && m > c)
                ? (f[a] = NaN)
                : (f[a] = m);
            }
          return { data: f, width: u, height: g };
        }
        function q(t, e, n) {
          let { data: r, width: a, height: i } = t;
          const o = 1e3 * n,
            s = (function (t, e, n) {
              const r = [n[0], n[3]],
                a = (n[2] - n[0]) / t,
            ...
            for (let a = 0; a < n; a++)
              for (let i = 0; i < e; i++) {
                ...
                if (i >= 1 && i <= e - 2 && a >= 1 && a <= n - 2) {
                  ...
                  r[o] = n.reduce((t, e) => t + e, 0) / n.length;
                } else r[o] = t[o];
              }
            return r;
          })(r, a, i);
          ...
          for (let t = 1; t < i - 1; t++)
            for (let e = 1; e < a - 1; e++) {
              ...
              if (
                ...
                const r = s([e, t]);
                l.push({ position: r, value: n });
              }
            }
          (A = A.sort((t, e) => e.value - t.value)),
            (l = l.sort((t, e) => t.value - e.value));
          const c = [...A];
          for (let t = 0; t < c.length; t++) {
            const e = c[t];
            if (e)
              for (let n = t + 1; n < c.length; n++) {
                const t = c[n];
                t && B(e.position, t.position) < o && (c[n] = void 0);
              }
          }
          A = c.filter((t) => !!t);
          const u = [...l];
          for (let t = 0; t < u.length; t++) {
            const e = u[t];
            if (e)
              for (let n = t + 1; n < u.length; n++) {
                const t = u[n];
                t && B(e.position, t.position) < o && (u[n] = void 0);
              }
          }
          return (
            (l = u.filter((t) => !!t)),
            new Float32Array([
              A.length,
              ...A.map((t) => [...t.position, t.value]).flat(),
              l.length,
              ...l.map((t) => [...t.position, t.value]).flat(),
            ])
          );
        }
        A({
          getHighLowPointData(t, e, n, r, a, i, o, s, A, l, c, u, g, d, p) {
            const h = (function (t, e, n) {
              return q(Z(t, e), e, n);
            })(
              {
                image: { data: t, width: e, height: n },
                image2: r ? { data: r, width: a, height: i } : null,
                imageSmoothing: o,
                imageInterpolation: s,
                imageWeight: A,
                imageType: l,
      ...
      (qr = Wr.toString()
        .replace(/^function.+?{/, "")
        .slice(0, -1)),
      `var browserWorkerPolyFill = ${Rr.toString()};\nbrowserWorkerPolyFill(self);\n` +
        qr);
  var qr,
    Wr,
    Gr = (function (t) {
  ...
  async function Xr(t, e, n) {
    const {
      ...
      { data: g, width: d, height: p } = r,
      { data: h = null, width: f = null, height: m = null } = a || {},
      C = g.slice(0),
      v = h ? h.slice(0) : null,
      I = (function (t) {
        let e = 0;
        ...
        for (let a = 0; a < r; a++) {
          const r = [t[e++], t[e++]],
            a = t[e++];
          n.push(jr(r, { type: zr.HIGH, value: a }));
        }
        const a = t[e++];
        for (let r = 0; r < a; r++) {
          const r = [t[e++], t[e++]],
            a = t[e++];
          n.push(jr(r, { type: zr.LOW, value: a }));
        }
        return n;
      })(
        await Kr.getHighLowPointData(
          Vr(C, [C.buffer]),
          d,
          p,
          v ? Vr(v, [v.buffer]) : null,
          f,
          m,
          i,
          o,
  ...
  const Yr = "high-low-label";
  function _r(t, e, n) {
    return t.properties.type === zr.HIGH
      ? Math.round(((t.properties.value - n) / n) * 100)
      : Math.round(((e - t.properties.value) / e) * 100);
  }
  const Hr = {
    image: { type: "object", value: null },
    image2: { type: "object", value: null },
    ...
    textFormatFunction: { type: "function", value: m },
    textFontFamily: { type: "object", value: p },
    textSize: { type: "number", value: 12 },
    textColor: { type: "color", value: h },
    textOutlineWidth: { type: "number", value: 1 },
    textOutlineColor: { type: "color", value: f },
    palette: { type: "object", value: null },
  };
  class $r extends e.CompositeLayer {
    renderLayers() {
      const { viewport: t } = this.context,
        { props: e, visiblePoints: a, minValue: i, maxValue: o } = this.state;
      if (!e || !a || "number" != typeof i || "number" != typeof o) return [];
      const {
          unitFormat: s,
          textFormatFunction: A,
          textFontFamily: l,
          textSize: c,
          textColor: u,
          textOutlineWidth: g,
        ...
        { paletteScale: p } = this.state;
      return [
        new n.TextLayer(
          this.getSubLayerProps({
            id: "type",
            data: a,
            getPixelOffset: [0, -vn(t, (1.2 * c) / 2)],
            getPosition: (t) => t.geometry.coordinates,
            getText: (t) => t.properties.type,
            getSize: 1.2 * c,
            getColor: (t) => (p ? bn(p(t.properties.value).rgba()) : u),
            getAngle: In(t, 0),
            outlineWidth: g,
            outlineColor: d,
            fontFamily: l,
            fontSettings: { sdf: !0 },
            billboard: !1,
            extensions: [new r.CollisionFilterExtension()],
            collisionEnabled: !0,
            collisionGroup: Yr,
            collisionTestProps: { sizeScale: 5 },
            getCollisionPriority: (t) => _r(t, i, o),
            parameters: {
              cullMode: "front",
              depthCompare: "always",
              ...this.props.parameters,
        ...
        new n.TextLayer(
          this.getSubLayerProps({
            ...
            getPixelOffset: [0, vn(t, (1.2 * c) / 2)],
            getPosition: (t) => t.geometry.coordinates,
            getText: (t) => A(t.properties.value, s),
            getSize: c,
            getColor: (t) => (p ? bn(p(t.properties.value).rgba()) : u),
            getAngle: In(t, 0),
            outlineWidth: g,
    ...
    shouldUpdateState(t) {
      return super.shouldUpdateState(t) || t.changeFlags.viewportChanged;
    }
    updateState(t) {
      const {
        image: e,
      ...
      super.updateState(t),
        g && E
          ? ((e === t.oldProps.image &&
              n === t.oldProps.image2 &&
              r === t.oldProps.imageSmoothing &&
              a === t.oldProps.imageInterpolation &&
              i === t.oldProps.imageWeight &&
              o === t.oldProps.imageType &&
              s === t.oldProps.imageUnscale &&
              A === t.oldProps.imageMinValue &&
              l === t.oldProps.imageMaxValue &&
              g === t.oldProps.radius &&
              E === t.oldProps.visible) ||
              this._updateFeatures(),
            (c !== t.oldProps.minZoom ||
              u !== t.oldProps.maxZoom ||
              t.changeFlags.viewportChanged) &&
              this._updateVisibleFeatures(),
            I !== t.oldProps.palette && this._updatePalette(),
            (d === t.oldProps.unitFormat &&
              p === t.oldProps.textFormatFunction &&
              h === t.oldProps.textFontFamily &&
              f === t.oldProps.textSize &&
              m === t.oldProps.textColor &&
              C === t.oldProps.textOutlineWidth &&
              v === t.oldProps.textOutlineColor) ||
              this._redrawVisibleFeatures(),
            this.setState({ props: t.props }))
          : this.setState({
              points: void 0,
              visiblePoints: void 0,
              minValue: void 0,
              maxValue: void 0,
            });
    }
    async _updateFeatures() {
      ...
      const g = {
        ...
        d = (await Xr(g, l, c)).features;
      if (this.state.requestId !== u) return;
      const p = d.map((t) => t.properties.value),
        h = Math.min(...p),
        f = Math.max(...p);
      this.setState({ points: d, minValue: h, maxValue: f }),
        this._updateVisibleFeatures();
    }
    _updateVisibleFeatures() {
      const { viewport: t } = this.context,
        { minZoom: e, maxZoom: n } = v(this.props, Hr),
        { points: r } = this.state;
      if (!r) return;
      let a;
      (a = pn(t, e, n) ? r : []), this.setState({ visiblePoints: a });
    }
    _updatePalette() {
      const { palette: t } = v(this.props, Hr);
      if (!t)
        return (
          this.setState({ paletteScale: void 0 }),
          void this._redrawVisibleFeatures()
        );
      const e = we(t);
      this.setState({ paletteScale: e }), this._redrawVisibleFeatures();
    }
  ...
  ($r.layerName = "HighLowCompositeLayer"), ($r.defaultProps = Hr);
  const ta = { ...$r.defaultProps };
  class ea extends e.CompositeLayer {
    renderLayers() {
      const { props: t } = this.state;
      return t
        ? [new $r(this.props, this.getSubLayerProps({ id: "composite" }))]
        : [];
    }
    updateState(t) {
      const { image: e, imageUnscale: n } = t.props;
      if (
        (super.updateState(t),
        e &&
          n &&
  ...
  (ea.layerName = "HighLowLayer"), (ea.defaultProps = ta);
  const na = {
      COLD: "COLD",
      WARM: "WARM",
      OCCLUDED: "OCCLUDED",
    ...
    ra = {
      ...
      iconMapping: {
        COLD: { x: 2, y: 2, width: 50, height: 38, anchorY: 35, mask: !0 },
        WARM: { x: 54, y: 2, width: 50, height: 38, anchorY: 35, mask: !0 },
      },
    };
  function aa(t, e) {
    for (let n = t.length - 1; n >= 0; n--) if (e.call(t, t[n], n, t)) return n;
    return -1;
  }
  const ia = {
    ...
    coldColor: { type: "color", value: [0, 0, 255] },
    warmColor: { type: "color", value: [255, 0, 0] },
    occludedColor: { type: "color", value: [148, 0, 211] },
    iconSize: { type: "number", value: 15 },
    _debug: { type: "boolean", value: !1 },
  };
  class oa extends e.CompositeLayer {
    renderLayers() {
      const { viewport: t } = this.context,
        {
          props: e,
          visibleFrontLines: a,
          visibleDebugFrontPoints: i,
        } = this.state;
      if (!e || !a || !i) return [];
      const {
        getType: o,
      ...
      if (!o || !s) return [];
      const { iconStyle: m, iconAtlasTexture: C } = this.state;
      if (!m || !C) return [];
      const I = {
        [na.COLD]: l,
        [na.WARM]: c,
      ...
      return [
        ...
        new n.PathLayer(
          this.getSubLayerProps({
            ...
            data: a.filter((t) => o(t.d) === na.STATIONARY),
            getPath: (t) => [
              t.startPosition,
              ...t.icons.map((t) => t.position),
              t.endPosition,
            ...
            widthUnits: "pixels",
            extensions: [
              new r.PathStyleExtension({ dash: !0, highPrecisionDash: !0 }),
            ],
            getDashArray: [45, 45],
          })
        ),
        new n.IconLayer(
          this.getSubLayerProps({
            id: "icon",
            data: a.flatMap((t) => t.icons),
            getPosition: (t) => t.position,
            getIcon: (t) =>
              o(t.d) === na.OCCLUDED || o(t.d) === na.STATIONARY
                ? t.alternate
                  ? na.COLD
                  : na.WARM
                : o(t.d),
            ...
            getAngle: (e) =>
              o(e.d) === na.STATIONARY
                ? e.alternate
                  ? In(t, e.direction)
                  : In(t, e.direction + 180)
                : In(t, e.direction),
            iconAtlas: C,
            iconMapping: m.iconMapping,
            billboard: !1,
            extensions: [new r.CollisionFilterExtension()],
            collisionEnabled: !0,
            collisionGroup: "front-icon",
            collisionTestProps: { sizeScale: 5 },
            getCollisionPriority: (t) => t.priority,
          })
        ),
        ...(d
          ? [
    ...
    updateState(t) {
      ...
      super.updateState(t),
        e && n && r
          ? (this.state.iconStyle || this._updateIconStyle(),
            (e === t.oldProps.data && r === t.oldProps.getPath) ||
              this._updateFeatures(),
            (a !== t.oldProps.minZoom ||
              i !== t.oldProps.maxZoom ||
              t.changeFlags.viewportChanged) &&
              this._updateVisibleFeatures(),
            this.setState({ props: t.props }))
          : this.setState({
              features: void 0,
              debugFeatures: void 0,
              visibleFeatures: void 0,
              visibleDebugFeatures: void 0,
            });
    }
    async _updateIconStyle() {
      const { device: t } = this.context;
      this.setState({ iconStyle: ra });
      const e = en(t, await w(ra.iconAtlas));
      this.setState({ iconAtlasTexture: e });
    }
    _updateFeatures() {
      const { data: t, getPath: e } = v(this.props, ia);
      if (!e) return;
      const n = t.map((t) =>
          (function (t, e) {
            const n = e,
              r = n
                .slice(0, -1)
                .map((t, e) => cn(n[e], n[e + 1]))
                .reduce((t, e) => [...t, t[t.length - 1] + e], [0]);
            let a = [];
            for (let t = 1, e = r[r.length - 1] / 3; e > 5e3; t++, e /= 3) {
              const i = 3 ** t;
              for (let o = 1; o < i; o++) {
                if (t > 1 && o % 3 == 0) continue;
                const i = o * e,
                  s = aa(r, (t) => t <= i);
                if (-1 === s || s === n.length - 1)
                  throw new Error("Invalid state");
                const A = s + 1,
                  ...
                  p = 90 - g,
                  h = 100 - t;
                a.push({ distance: i, position: d, direction: p, priority: h });
              }
            }
            a = a.sort((t, e) => t.distance - e.distance);
            const i = a.map((e, n) => ({ d: t, ...e, alternate: n % 2 == 0 }));
            return {
              d: t,
              startPosition: e[0],
              endPosition: e[e.length - 1],
              icons: i,
            };
          })(t, e(t))
        ),
        r = t.flatMap((t) =>
          e(t).map((e, n) => ({ d: t, position: e, index: n }))
        );
    ...
    _updateVisibleFeatures() {
      const { viewport: t } = this.context,
        { minZoom: e, maxZoom: n } = v(this.props, ia),
        { frontLines: r, debugFrontPoints: a } = this.state;
      if (!r || !a) return;
      let i, o;
      pn(t, e, n) ? ((i = r), (o = a)) : ((i = []), (o = [])),
        this.setState({ visibleFrontLines: i, visibleDebugFrontPoints: o });
    }
  }
  (oa.layerName = "FrontCompositeLayer"), (oa.defaultProps = ia);
  const sa = { ...oa.defaultProps };
  class Aa extends e.CompositeLayer {
    renderLayers() {
      return [new oa(this.props, this.getSubLayerProps({ id: "composite" }))];
    }
  }
  (Aa.layerName = "FrontLayer"), (Aa.defaultProps = sa);
  const la = Math.PI / 180,
    ca = 180 / Math.PI,
    ua = 6378137,
    ga = 20037508.342789244,
    da = "900913",
    pa = {};
  function ha(t) {
  ...
  class fa {
    ...
    px(t, e) {
      if (ha(e)) {
        const n = this.#t * Math.pow(2, e),
          r = n / 2,
          a = n / 360,
          i = n / (2 * Math.PI),
          o = n,
          s = Math.min(Math.max(Math.sin(la * t[1]), -0.9999), 0.9999);
        let A = r + t[0] * a,
          l = r + 0.5 * Math.log((1 + s) / (1 - s)) * -i;
        return A > o * this.#e && (A = o * this.#e), l > o && (l = o), [A, l];
      }
      {
        const n = this.#a[e],
          r = Math.min(Math.max(Math.sin(la * t[1]), -0.9999), 0.9999);
        let a = Math.round(n + t[0] * this.#n[e]),
          i = Math.round(n + 0.5 * Math.log((1 + r) / (1 - r)) * -this.#r[e]);
        return (
          a > this.#i[e] * this.#e && (a = this.#i[e] * this.#e),
          i > this.#i[e] && (i = this.#i[e]),
          [a, i]
        );
      }
    }
    ll(t, e) {
      if (ha(e)) {
        ...
        return [
          (t[0] - i) / r,
          ca * (2 * Math.atan(Math.exp(o)) - 0.5 * Math.PI),
        ];
      }
      {
        const n = (t[1] - this.#a[e]) / -this.#r[e];
        return [
          (t[0] - this.#a[e]) / this.#n[e],
          ca * (2 * Math.atan(Math.exp(n)) - 0.5 * Math.PI),
        ];
      }
    }
    convert(t, e) {
      return e === da
        ? [...this.forward(t.slice(0, 2)), ...this.forward(t.slice(2, 4))]
        : [...this.inverse(t.slice(0, 2)), ...this.inverse(t.slice(2, 4))];
    }
    inverse(t) {
      return [
        (t[0] * ca) / ua,
        (0.5 * Math.PI - 2 * Math.atan(Math.exp(-t[1] / ua))) * ca,
      ];
    }
    forward(t) {
      const e = [
        ua * t[0] * la,
        ua * Math.log(Math.tan(0.25 * Math.PI + 0.5 * t[1] * la)),
      ];
      return (
        e[0] > ga && (e[0] = ga),
        e[0] < -ga && (e[0] = -ga),
    ...
    bbox(t, e, n, r, a) {
      ...
      const i = [t * this.#t, (+e + 1) * this.#t],
        o = [(+t + 1) * this.#t, e * this.#t],
        s = [...this.ll(i, n), ...this.ll(o, n)];
      return a === da ? this.convert(s, da) : s;
    }
    xyz(t, e, n, r) {
      const a = r === da ? this.convert(t, "WGS84") : t,
        i = [a[0], a[1]],
        o = [a[2], a[3]],
        s = this.px(i, e),
        A = this.px(o, e),
        l = [Math.floor(s[0] / this.#t), Math.floor((A[0] - 1) / this.#t)],
        c = [Math.floor(A[1] / this.#t), Math.floor((s[1] - 1) / this.#t)],
        u = {
  ...
  class Ca {
    ...
    constructor(t, e = 64, n = Float64Array, r) {
      ...
      const a = ma.indexOf(this.ArrayType),
        i = 2 * t * this.ArrayType.BYTES_PER_ELEMENT,
        o = t * this.IndexArrayType.BYTES_PER_ELEMENT,
        s = (8 - (o % 8)) % 8;
      if (a < 0) throw new Error(`Unexpected typed array class: ${n}.`);
      r && r instanceof ArrayBuffer
        ? ((this.data = r),
          (this.ids = new this.IndexArrayType(this.data, 8, t)),
          (this.coords = new this.ArrayType(this.data, 8 + o + s, 2 * t)),
          (this._pos = 2 * t),
          (this._finished = !0))
        : ((this.data = new ArrayBuffer(8 + i + o + s)),
          (this.ids = new this.IndexArrayType(this.data, 8, t)),
          (this.coords = new this.ArrayType(this.data, 8 + o + s, 2 * t)),
          (this._pos = 0),
          (this._finished = !1),
    ...
    finish() {
      ...
      return (
        va(this.ids, this.coords, this.nodeSize, 0, this.numItems - 1, 0),
        (this._finished = !0),
        this
      );
    }
    range(t, e, n, r) {
      ...
      const { ids: a, coords: i, nodeSize: o } = this,
        s = [0, a.length - 1, 0],
        A = [];
      for (; s.length; ) {
        const l = s.pop() || 0,
        ...
        const g = (u + c) >> 1,
          d = i[2 * g],
          p = i[2 * g + 1];
        d >= t && d <= n && p >= e && p <= r && A.push(a[g]),
          (0 === l ? t <= d : e <= p) &&
            (s.push(u), s.push(g - 1), s.push(1 - l)),
          (0 === l ? n >= d : r >= p) &&
            (s.push(g + 1), s.push(c), s.push(1 - l));
      }
      return A;
    }
    within(t, e, n) {
      if (!this._finished)
        throw new Error("Data not yet indexed - call index.finish().");
      const { ids: r, coords: a, nodeSize: i } = this,
        o = [0, r.length - 1, 0],
        s = [],
        A = n * n;
      for (; o.length; ) {
        ...
        if (c - u <= i) {
          for (let n = u; n <= c; n++)
            ba(a[2 * n], a[2 * n + 1], t, e) <= A && s.push(r[n]);
          continue;
        }
        const g = (u + c) >> 1,
          d = a[2 * g],
          p = a[2 * g + 1];
        ba(d, p, t, e) <= A && s.push(r[g]),
          (0 === l ? t - n <= d : e - n <= p) &&
            (o.push(u), o.push(g - 1), o.push(1 - l)),
          (0 === l ? t + n >= d : e + n >= p) &&
            (o.push(g + 1), o.push(c), o.push(1 - l));
      }
      return s;
    }
  }
    ...
    for (; a > r; ) {
      if (a - r > 600) {
        ...
        Ia(
          ...
          e,
          n,
          Math.max(r, Math.floor(n - (s * l) / o + c)),
          Math.min(a, Math.floor(n + ((o - s) * l) / o + c)),
          i
        );
      }
      const o = e[2 * n + i];
      let s = r,
        A = a;
      for (Ea(t, e, r, n), e[2 * a + i] > o && Ea(t, e, r, a); s < A; ) {
        for (Ea(t, e, s, A), s++, A--; e[2 * s + i] < o; ) s++;
        for (; e[2 * A + i] > o; ) A--;
      }
      e[2 * r + i] === o ? Ea(t, e, r, A) : (A++, Ea(t, e, A, a)),
        A <= n && (r = A + 1),
        n <= A && (a = A - 1);
    }
  }
  function Ea(t, e, n, r) {
    ya(t, n, r), ya(e, 2 * n, 2 * r), ya(e, 2 * n + 1, 2 * r + 1);
  }
  function ya(t, e, n) {
    const r = t[e];
    (t[e] = t[n]), (t[n] = r);
  ...
  class Ba {
    ...
    pop() {
      ...
      const t = this.data[0],
        e = this.data.pop();
      return (
        this.length--, this.length > 0 && ((this.data[0] = e), this._down(0)), t
      );
    }
    peek() {
      return this.data[0];
    ...
    _down(t) {
      ...
      for (; t < r; ) {
        ...
        const o = r + 1;
        if (
          (o < this.length && n(e[o], i) < 0 && ((r = o), (i = e[o])),
          n(i, a) >= 0)
        )
          break;
        (e[t] = i), (t = r);
  ...
  function Ta(t, e, n, r) {
    const a = r.minLng,
      ...
      s = r.maxLat;
    if (t >= a && t <= i)
      return e < o ? Oa((e - o) * xa) : e > s ? Oa((e - s) * xa) : 0;
    const A = Math.min(Oa((t - a) * xa), Oa((t - i) * xa)),
      l = (function (t, e) {
        const n = 1 - 2 * e;
        return n <= 0
          ? t > 0
            ? 90
            : -90
          : Math.atan(Math.tan(t * xa) / n) / xa;
      })(e, A);
    return l > o && l < s
      ? Sa(A, n, e, l)
      : Math.min(Sa(A, n, e, o), Sa(A, n, e, s));
  }
  function Ma(t, e) {
  ...
  function Sa(t, e, n, r) {
    return e * Math.cos(r * xa) * t + Oa((n - r) * xa);
  }
  function Pa(t, e, n, r, a) {
    return Sa(Oa((t - n) * xa), a, e, r);
  }
  const La = new Map(),
    Na = new Map();
  function Ua(t, e = 0) {
    ...
    if (gn(t)) {
      n = (function (t, e, n) {
        const r = 7;
        n = Math.min(Math.max(n - 2, 0), r);
        const a =
            La.get(n) ??
            (() => {
              const { uv: t } = (function (t = 4, e = !1) {
                  if (t > 10)
                    throw new Error(`Max order is 10, but given ${t}.`);
                  const n = (1 + Math.sqrt(5)) / 2,
                    r = 10 * Math.pow(4, t) + 2,
                    a = e ? (0 === t ? 3 : 3 * Math.pow(2, t) + 9) : 0,
                    i = new Float32Array(3 * (r + a));
                  i.set(
                    Float32Array.of(
                      -1,
                      n,
                  ...
                  let o = Uint16Array.of(
                    ...
                    s = 12;
                  const A = t ? new Map() : null;
                  function l(t, e) {
                    const n = Math.floor(
                        ((t + e) * (t + e + 1)) / 2 + Math.min(t, e)
                      ),
                      r = A.get(n);
                    return void 0 !== r
                      ? (A.delete(n), r)
                      : (A.set(n, s),
                        (i[3 * s + 0] = 0.5 * (i[3 * t + 0] + i[3 * e + 0])),
                        (i[3 * s + 1] = 0.5 * (i[3 * t + 1] + i[3 * e + 1])),
                        (i[3 * s + 2] = 0.5 * (i[3 * t + 2] + i[3 * e + 2])),
                        s++);
                  }
                  let c = o;
                  const u = t > 5 ? Uint32Array : Uint16Array;
                  for (let e = 0; e < t; e++) {
                    const t = c.length;
                    o = new u(4 * t);
                    for (let e = 0; e < t; e += 3) {
                  ...
                  for (let t = 0; t < 3 * r; t += 3) {
                    const e = i[t + 0],
                      n = i[t + 1],
                      r = i[t + 2],
                      a = 1 / Math.sqrt(e * e + n * n + r * r);
                    (i[t + 0] *= a), (i[t + 1] *= a), (i[t + 2] *= a);
                  }
                  if (!e) return { vertices: i, triangles: o };
                  const g = new Float32Array(2 * (r + a));
                  for (let t = 0; t < r; t++)
                    (g[2 * t + 0] =
                      Math.atan2(i[3 * t + 2], i[3 * t]) / (2 * Math.PI) + 0.5),
                      (g[2 * t + 1] = Math.asin(i[3 * t + 1]) / Math.PI + 0.5);
                  const d = new Map();
                  function p(t, e, n, r) {
                    if (r) {
                      const e = d.get(t);
                  ...
                  return { vertices: i, triangles: o, uv: g };
                })(n, !0),
                e = [];
              ...
              return e.push([0, -90]), e.push([0, 90]), e;
            })(),
          i =
            Na.get(n) ??
            (() => {
              const t = new Ca(a.length, void 0, Float32Array);
              for (let e = 0; e < a.length; e++) {
                const n = a[e];
                t.add(n[0], n[1]);
              }
          ...
          o = (function (t, e, n, r = 1 / 0, a = 1 / 0, i) {
            let o = 1;
            const s = [];
            void 0 === r && (r = 1 / 0), void 0 !== a && (o = Oa(a / Qa));
            const A = new Ba([], Ma);
            let l = {
              left: 0,
              right: t.ids.length - 1,
              axis: 0,
              minLng: -180,
              minLat: -90,
              maxLng: 180,
            ...
            for (; l; ) {
              ...
              if (a - i <= t.nodeSize)
                for (let r = i; r <= a; r++) {
                  const a = t.ids[r];
                  {
                    const i = Pa(e, n, t.coords[2 * r], t.coords[2 * r + 1], c);
                    A.push({ id: a, dist: i });
                  }
                }
              else {
                ...
                const g = (l.axis + 1) % 2,
                  d = {
                    ...
                    minLng: l.minLng,
                    minLat: l.minLat,
                    maxLng: 0 === l.axis ? o : l.maxLng,
                    maxLat: 1 === l.axis ? s : l.maxLat,
                    dist: 0,
                  },
                  p = {
                    left: r + 1,
                    right: a,
                    axis: g,
                    minLng: 0 === l.axis ? o : l.minLng,
                    minLat: 1 === l.axis ? s : l.minLat,
                    maxLng: l.maxLng,
                    maxLat: l.maxLat,
                    dist: 0,
                  };
              ...
              for (; A.length && null != A.peek().id; ) {
                const t = A.pop();
                if (t.dist > o) return s;
                if ((s.push(t.id), s.length === r)) return s;
              }
              l = A.pop();
            }
            return s;
          })(i, t[0], t[1], void 0, e / 1e3).map((t) => a[t]);
        return o;
      })(hn(t), fn(t), Math.floor(Cn(t) + e + 1));
    } else {
      if (!dn(t)) throw new Error("Invalid state");
      n = (function (t, e) {
        const n = new fa({ size: 1, antimeridian: !0 }),
          r = [...n.px([t[0], t[1]], e), ...n.px([t[2], t[3]], e)];
        [r[1], r[3]] = [r[3], r[1]];
        const a = 2 ** e,
          i = r[2] - r[0] + 1,
          o = r[3] - r[1] + 1,
        ...
        for (let t = 0; t < o; t++)
          for (let o = 0; o < i; o++) {
            const i = r[0] + o,
              A = [i, r[1] + t + (i % 2 == 1 ? 0.5 : 0)];
            if (0 === A[0]) continue;
            if (A[1] <= 0 || A[1] >= a) continue;
            const l = n.ll([A[0], A[1]], e);
            (l[0] = Xe(l[0])), s.push(l);
          }
        return s;
      })(mn(t), Math.floor(Cn(t) + e));
    }
    return n;
  }
  const Da = { VALUE: "VALUE", ARROW: "ARROW", WIND_BARB: "WIND_BARB" },
    Va = new Map([
      [
        Da.ARROW,
        {
          ...
          iconMapping: { 0: { x: 0, y: 0, width: 100, height: 100, mask: !0 } },
        },
      ],
      [
        Da.WIND_BARB,
    ...
    Fa = {
      ...
      minZoom: { type: "object", value: null },
      maxZoom: { type: "object", value: null },
      style: { type: "object", value: Da.VALUE },
      ...
      iconSize: { type: "object", value: 40 },
      iconColor: { type: "color", value: C },
      palette: { type: "object", value: null },
    };
  class ka extends e.CompositeLayer {
    renderLayers() {
      const { viewport: t } = this.context,
        { props: e, visiblePoints: r } = this.state;
      if (!e || !r) return [];
      const {
          style: a,
          unitFormat: i,
          textFormatFunction: o,
          textFontFamily: s,
          textSize: A,
          textColor: l,
          textOutlineWidth: c,
        ...
        { paletteScale: p } = this.state;
      if (Va.has(a)) {
        const { iconStyle: a, iconAtlasTexture: i } = this.state;
        if (!a || !i) return [];
        const o = Object.keys(a.iconMapping).length,
          s = e.iconBounds ?? a.iconBounds ?? [0, 0],
          A = s[1] - s[0],
          l = (t) => (t - s[0]) / A,
          c = Array.isArray(g) ? g[1] - g[0] : 0;
        return [
          new n.IconLayer(
            this.getSubLayerProps({
              id: "icon",
              ...
              getIcon: (t) =>
                `${Math.min(
                  Math.max(Math.floor(l(t.properties.value) * o), 0),
                  o - 1
                )}`,
              getSize: (t) =>
                Array.isArray(g) ? g[0] + l(t.properties.value) * c : g,
              getColor: (t) => (p ? bn(p(t.properties.value).rgba()) : d),
              getAngle: (e) =>
                In(
                  t,
                  e.properties.direction ? 360 - e.properties.direction : 0
                ),
              iconAtlas: i,
              iconMapping: a.iconMapping,
              billboard: !1,
              parameters: {
                cullMode: "front",
                depthCompare: "always",
      ...
      return [
        new n.TextLayer(
          this.getSubLayerProps({
            ...
            data: r,
            getPosition: (t) => t.geometry.coordinates,
            getText: (t) => o(t.properties.value, i),
            getSize: A,
            getColor: (t) => (p ? bn(p(t.properties.value).rgba()) : l),
            getAngle: In(t, 0),
            outlineWidth: c,
            outlineColor: u,
            fontFamily: s,
    ...
    updateState(t) {
      ...
      super.updateState(t),
        B
          ? ((this.state.iconStyle && g === t.oldProps.style) ||
              this._updateIconStyle(),
            (d !== t.oldProps.density || t.changeFlags.viewportChanged) &&
            ...
            (e === t.oldProps.image &&
              ...
              A === t.oldProps.imageMinValue &&
              l === t.oldProps.imageMaxValue &&
              B === t.oldProps.visible) ||
              this._updateFeatures(),
            (c !== t.oldProps.minZoom ||
              u !== t.oldProps.maxZoom ||
              t.changeFlags.viewportChanged) &&
              this._updateVisibleFeatures(),
            b !== t.oldProps.palette && this._updatePalette(),
            (p === t.oldProps.unitFormat &&
              h === t.oldProps.textFormatFunction &&
              f === t.oldProps.textFontFamily &&
              m === t.oldProps.textSize &&
              C === t.oldProps.textColor &&
              v === t.oldProps.textOutlineWidth &&
              I === t.oldProps.textOutlineColor &&
              E === t.oldProps.iconSize &&
              y === t.oldProps.iconColor) ||
              this._redrawVisibleFeatures(),
            this.setState({ props: t.props }))
          : this.setState({ points: void 0, visiblePoints: void 0 });
    }
    async _updateIconStyle() {
      const { device: t } = this.context,
        { style: e } = v(this.props, Fa),
        n = Va.get(e);
      if (!n)
        return void this.setState({
          iconStyle: void 0,
          iconAtlasTexture: void 0,
        });
      this.setState({ iconStyle: n });
      const r = en(t, await w(n.iconAtlas));
      this.setState({ iconAtlasTexture: r });
    }
    _updatePositions() {
      const { viewport: t } = this.context,
        { density: e } = v(this.props, Fa),
        n = Ua(t, e + 3);
    ...
    _updateFeatures() {
      ...
      const u = He(
        ...
        l,
        c
      ).features.filter((t) => !isNaN(t.properties.value));
      this.setState({ points: u }), this._updateVisibleFeatures();
    }
    _updateVisibleFeatures() {
      const { viewport: t } = this.context,
        { minZoom: e, maxZoom: n } = v(this.props, Fa),
        { points: r } = this.state;
      if (!r) return;
      let a;
      (a = pn(t, e, n) ? r : []), this.setState({ visiblePoints: a });
    ...
    _updatePalette() {
      const { palette: t } = v(this.props, Fa);
      if (!t)
        return (
          this.setState({ paletteScale: void 0 }),
          void this._redrawVisibleFeatures()
  ...
  (ka.layerName = "GridCompositeLayer"), (ka.defaultProps = Fa);
  const Ja = { ...ka.defaultProps };
  class Ra extends e.CompositeLayer {
    renderLayers() {
      const { props: t } = this.state;
      return t
        ? [new ka(this.props, this.getSubLayerProps({ id: "composite" }))]
        : [];
    }
    updateState(t) {
      const { image: e, imageUnscale: n } = t.props;
  ...
  (Ra.layerName = "GridLayer"), (Ra.defaultProps = Ja);
  const Za =
      "uniform particleUniforms{float w;vec2 x;float y;vec4 z;float AA;float AB;float AC;float AD;float AE;float AF;}particle;",
    qa = "w",
    Wa = "x",
    Ga = "y",
    za = "z",
  ...
  const $a = {
      ...
      getUniforms: function (t = {}) {
        return {
          [qa]: t.viewportGlobe ? 1 : 0,
          [Wa]: t.viewportGlobeCenter ?? [0, 0],
          [Ga]: t.viewportGlobeRadius ?? 0,
          [za]: t.viewportBounds ?? [0, 0, 0, 0],
          [Ka]: t.viewportZoomChangeFactor ?? 0,
          [ja]: t.numParticles,
          [Xa]: t.maxAge,
          [Ya]: t.speedFactor,
          [_a]: t.time,
    ...
    ai = {
      ...
      imageInterpolation: { type: "object", value: S.CUBIC },
      imageWeight: { type: "number", value: 0 },
      imageType: { type: "object", value: P.VECTOR },
      imageUnscale: { type: "array", value: null },
      imageMinValue: { type: "object", value: null },
      imageMaxValue: { type: "object", value: null },
      bounds: { type: "array", value: [-180, -90, 180, 90], compare: !0 },
      minZoom: { type: "object", value: null },
      maxZoom: { type: "object", value: 15 },
      palette: { type: "object", value: null },
      color: { type: "color", value: d },
  ...
  class ii extends n.LineLayer {
    ...
    initializeState() {
      ...
      t.remove([
        ...
        t.addInstanced({
          instanceSourcePositions: { size: 3, type: "float32", noAlloc: !0 },
          instanceTargetPositions: { size: 3, type: "float32", noAlloc: !0 },
          instanceColors: { size: 4, type: "float32", noAlloc: !0 },
          instanceOpacities: { size: 1, type: "float32", noAlloc: !0 },
        });
    }
    updateState(t) {
      const {
      ...
      super.updateState(t),
        o && e === P.VECTOR && n && r && a
          ? ((e === t.oldProps.imageType &&
              n === t.oldProps.numParticles &&
              r === t.oldProps.maxAge &&
              a === t.oldProps.width &&
              o === t.oldProps.visible) ||
              this._setupTransformFeedback(),
            i !== t.oldProps.palette && this._updatePalette())
          : this._deleteTransformFeedback();
    }
    finalizeState(t) {
      this._deleteTransformFeedback(), super.finalizeState(t);
    }
    draw(t) {
      const { initialized: e } = this.state;
      if (!e) return;
      const { viewport: n } = this.context,
        { model: r } = this.state,
        { minZoom: a, maxZoom: i, width: o, animate: s } = v(this.props, ai),
        {
          sourcePositions: A,
          targetPositions: l,
          sourceColors: c,
    ...
    _runTransformFeedback() {
      ...
      if (!t) return;
      const { device: n, viewport: r, timeline: a } = this.context,
        {
          imageTexture: i,
          imageTexture2: o,
          imageSmoothing: s,
        ...
        } = v(this.props, ai),
        {
          ...
          targetColors: Q,
          transform: x,
          previousViewportZoom: T,
          previousTime: M,
        } = this.state;
      if (!(i && "number" == typeof y && b && B && w && Q && x)) return;
      const O = a.getTime();
      if ("number" == typeof M && O < M + 1e3 / 30) return;
      const S = gn(r),
        P = gn(r) ? hn(r) : void 0,
        L = gn(r) ? fn(r) : void 0,
        N = dn(r) ? mn(r) : void 0,
        U = 2 ** (4 * ("number" == typeof T ? T - Cn(r) : 0)),
        D = C / 2 ** (Cn(r) + 7);
      x.model.shaderInputs.setProps({
        [Un.name]: {
          viewportGlobe: S,
          bounds: p,
          _imageCoordinateSystem: e.COORDINATE_SYSTEM.LNGLAT,
        ...
        [ar.name]: {
          paletteTexture: I ?? rn(n),
          paletteBounds: E,
          paletteColor: h,
        },
        [$a.name]: {
          viewportGlobe: S,
          viewportGlobeCenter: P,
          viewportGlobeRadius: L,
          viewportBounds: N,
          viewportZoomChangeFactor: U,
          numParticles: f,
          maxAge: m,
          speedFactor: D,
          time: O,
      ...
      const V = n.createCommandEncoder();
      V.copyBufferToBuffer({
        sourceBuffer: b,
        sourceOffset: 0,
        destinationBuffer: B,
        destinationOffset: 4 * f * 3,
        size: 4 * y * 3,
      }),
        V.copyBufferToBuffer({
          sourceBuffer: w,
          sourceOffset: 0,
          destinationBuffer: Q,
          destinationOffset: 4 * f * 4,
          size: 4 * y * 4,
        }),
        V.finish(),
        V.destroy(),
        this._swapTransformFeedback(),
        (this.state.previousViewportZoom = Cn(r)),
        (this.state.previousTime = O);
    }
    _swapTransformFeedback() {
      ...
      t &&
        ...
        r &&
        a &&
        ((this.state.sourcePositions = e),
        (this.state.targetPositions = t),
        (this.state.sourceColors = r),
        (this.state.targetColors = n),
        a.model.setAttributes({ [ti]: e, [ni]: r }),
        a.transformFeedback.setBuffers({ [ei]: t, [ri]: n }));
    }
    _resetTransformFeedback() {
      ...
      "number" == typeof e &&
        ...
        a &&
        i &&
        (n.write(new Float32Array(3 * e)),
        r.write(new Float32Array(3 * e)),
        a.write(new Float32Array(4 * e)),
        i.write(new Float32Array(4 * e)));
    }
  ...
  (ii.layerName = "ParticleLineLayer"), (ii.defaultProps = ai);
  const oi = {
    ...ii.defaultProps,
    imageTexture: void 0,
    imageTexture2: void 0,
  ...
  class si extends e.CompositeLayer {
    renderLayers() {
      const { device: t } = this.context,
        { props: e, imageTexture: n, imageTexture2: r } = this.state;
      return e && n
        ? [
            new ii(
              this.props,
  ...
  (si.layerName = "ParticleLayer"), (si.defaultProps = oi);
  class Ai {
    addTo(t) {
      t.appendChild(this.onAdd());
    }
    prependTo(t) {
      t.prepend(this.onAdd());
    }
    remove() {
      this.onRemove();
    }
    updateConfig(t) {
      this.setConfig({ ...this.getConfig(), ...t });
    }
  }
  function li(t, e) {
    void 0 === e && (e = {});
  ...
  (t.Animation = I),
    (t.AttributionControl = class extends Ai {
      ...
      setConfig(t) {
        ...
        if (
          ...
          this._config.attribution === t.attribution
        )
          return;
        this._config = t;
        const e = this._config.attribution;
        this._container.innerHTML = `<div>${e}</div>`;
      }
    }),
    (t.ContourLayer = mr),
    (t.DATETIME = "2025-09-15T08:34:52.655Z"),
    (t.DEFAULT_ICON_COLOR = C),
    (t.DEFAULT_ICON_SIZE = 40),
    (t.DEFAULT_LINE_COLOR = d),
    (t.DEFAULT_LINE_WIDTH = 1),
    (t.DEFAULT_TEXT_COLOR = h),
    (t.DEFAULT_TEXT_FONT_FAMILY = p),
    (t.DEFAULT_TEXT_FORMAT_FUNCTION = m),
    (t.DEFAULT_TEXT_OUTLINE_COLOR = f),
    (t.DEFAULT_TEXT_OUTLINE_WIDTH = 1),
    (t.DEFAULT_TEXT_SIZE = 12),
    (t.DirectionFormat = s),
    (t.DirectionType = o),
    (t.FrontLayer = Aa),
    (t.FrontType = na),
    ...
    (t.GridStyle = Da),
    (t.HighLowLayer = ea),
    (t.ImageInterpolation = S),
    (t.ImageType = P),
    (t.LegendControl = class extends Ai {
      constructor(t = {}) {
        super(), (this._container = void 0), (this._config = t);
      }
      onAdd() {
        return (
          (this._container = document.createElement("div")),
          this._container.classList.add(ci),
          this.setConfig(this._config),
          this._container
        );
      }
      ...
      setConfig(t) {
        if (!this._container) return;
        if (!t.title || !t.unitFormat || !t.palette) return;
        if (
          this._container.children.length > 0 &&
          this._config.width === t.width &&
          this._config.ticksCount === t.ticksCount &&
          this._config.title === t.title &&
          this._config.unitFormat === t.unitFormat &&
          this._config.palette === t.palette
        )
          return;
        this._config = t;
        const e = this._config.width ?? 300,
          n = this._config.ticksCount ?? 6,
          r = this._config.title,
          a = this._config.unitFormat,
          i = we(this._config.palette),
          o = i.domain(),
          s = [o[0], o[o.length - 1]],
          A = Qe(i).toDataURL();
        (this._container.innerHTML = ""),
          (this._container.style.width = `${e}px`);
        const u = document.createElement("div");
        this._container.appendChild(u);
        const g = document.createElement("header");
        u.appendChild(g);
        const d = document.createElement("span");
        d.classList.add(ui), (d.innerHTML = `${r} [${c(a)}]`), g.appendChild(d);
        const p = document.createElement("main");
        u.appendChild(p);
        const h = "http://www.w3.org/2000/svg",
          f = document.createElementNS(h, "svg");
        f.setAttribute("height", "24px"),
          f.setAttribute("class", "weatherlayers-legend-control__legend"),
          p.appendChild(f);
        const m = document.createElementNS(h, "image");
        m.setAttribute("href", A),
          m.setAttribute("width", "100%"),
          m.setAttribute("height", "5"),
        ...
        for (let t = 0; t < n; t++) {
          const e = s[0] + t * C,
            r = l(e, a),
            i = document.createElementNS(h, "g");
          (i.style.transform = `translate(${
            ((e - s[0]) / (s[1] - s[0])) * 100
          }%, 0)`),
            f.appendChild(i);
          const o = document.createElementNS(h, "line");
          o.setAttribute("y1", "0"),
            o.setAttribute("y2", "10"),
            (o.style.stroke = "currentColor"),
            0 === t
              ? (o.style.transform = "translate(0.5px, 0)")
              : t === n - 1 && (o.style.transform = "translate(-0.5px, 0)"),
            i.appendChild(o);
          const A = document.createElementNS(h, "text");
          (A.innerHTML = r),
            A.setAttribute("x", "0"),
            A.setAttribute("y", "22"),
            (A.style.textAnchor =
              0 === t ? "start" : t === n - 1 ? "end" : "middle"),
            i.appendChild(A);
        }
      }
    }),
    (t.LogoControl = class extends Ai {
      constructor(t = {}) {
        super(), (this._container = void 0), (this._config = t);
      }
      onAdd() {
        return (
          (this._container = document.createElement("div")),
          this._container.classList.add("weatherlayers-logo-control"),
          this.setConfig(this._config),
          this._container
        );
      }
      ...
      setConfig(t) {
        if (!this._container) return;
        (this._config = t), (this._container.innerHTML = "");
        const e = document.createElement("a");
        (e.href = "https://weatherlayers.com"),
          (e.target = "_blank"),
          (e.ariaLabel = "WeatherLayers"),
    ...
    (t.Placement = xe),
    (t.RasterLayer = Ar),
    (t.TimelineControl = class extends Ai {
      constructor(t = {}) {
        super(),
          (this._container = void 0),
          (this._currentDatetime = void 0),
          (this._progressInput = void 0),
          (this._loaderText = void 0),
          (this._loading = !1),
          (this._config = t),
          (this._animation = new I({
            onUpdate: () => this._animationUpdated(),
            fps: this._config.fps ?? 15,
          }));
      }
      onAdd() {
        return (
          (this._container = document.createElement("div")),
          this._container.classList.add(mi),
          this.setConfig(this._config),
          this._container
        );
      }
      ...
      async toggle(t = !this._running) {
        return t ? await this.start() : this.pause();
      }
      async start() {
        !this._container ||
          this._loading ||
          ...
          this._container.classList.add(Pi),
      ...
      pause() {
        this._container &&
          ...
          this._container.classList.remove(Pi),
          this._updateProgress());
      }
      stop() {
        this._container &&
      ...
      reset() {
        !this._progressInput ||
          this._loading ||
          this._running ||
          ((this._progressInput.valueAsNumber = 0), this._updateProgress());
      }
      async stepBackward() {
        !this._progressInput ||
          this._loading ||
      ...
      get _startEndDatetimes() {
        ...
        const t =
            this._config.datetimes[
              Math.floor(this._progressInput.valueAsNumber)
            ],
          e =
            this._config.datetimes[
              Math.ceil(this._progressInput.valueAsNumber)
            ];
        return t === e ? [t] : [t, e];
      }
      _updateProgress() {
        ...
        const t = x(
          ...
          this._progressInput.valueAsNumber % 1
        );
        this._config.datetime = t;
        const e = this._config.datetimeFormatFunction ?? O;
        (this._currentDatetime.innerHTML = e(t)),
          this._config.onUpdate && this._config.onUpdate(t);
      }
      ...
      async _preload(t) {
        if (!this._container || !this._loaderText || !this._config.onPreload)
          return;
        (this._loading = !0), this._container.classList.add(Si);
        const e = this._config.onPreload(t);
        if (Array.isArray(e)) {
          let t = 0;
          const n = () => {
            this._loaderText.innerHTML = `Loading... ${t}/${e.length}`;
          };
          n();
          for (let r of e)
            r.then(() => {
          ...
          await Promise.all(e), (this._loaderText.innerHTML = "");
        } else
          (this._loaderText.innerHTML = "Loading..."),
            await e,
            (this._loaderText.innerHTML = "");
        (this._loading = !1), this._container.classList.remove(Si);
      }
      getConfig() {
        return { ...this._config };
      }
      setConfig(t) {
        ...
        if (
          !t.datetimes ||
          t.datetimes.length < 2 ||
          !t.datetime ||
          t.datetime < t.datetimes[0] ||
          t.datetime > t.datetimes[t.datetimes.length - 1]
        )
          return;
        if (
          this._container.children.length > 0 &&
          this._config.width === t.width &&
          this._config.datetimes.length === t.datetimes.length &&
          this._config.datetimes.every((e, n) => e === t.datetimes[n]) &&
          this._config.datetime === t.datetime &&
          this._config.datetimeInterpolate === t.datetimeInterpolate &&
          this._config.datetimeFormatFunction === t.datetimeFormatFunction &&
          this._config.onPreload === t.onPreload &&
          this._config.onUpdate === t.onUpdate
        )
          return;
        this._config = t;
        const e = this._config.width ?? 300,
          n = this._config.datetimes,
          r = this._config.datetime,
          a = this._config.datetimeInterpolate ?? !1,
          i = this._config.datetimeFormatFunction ?? O,
          o = aa(n, (t) => t <= r);
        if (o < 0) throw new Error("Invalid state");
        const s = o < n.length - 1 ? o + 1 : null,
          A = T(n[o], "number" == typeof s ? n[o + 1] : null, r),
          l = a ? 0.25 : 1,
          c = o + Math.floor(A / l) * l;
        (this._container.innerHTML = ""),
          (this._container.style.width = `${e}px`);
        const u = document.createElement("div");
        this._container.appendChild(u);
        ...
        u.appendChild(g),
          ...
          this._currentDatetime.classList.add(Ci),
          (this._currentDatetime.innerHTML = i(r)),
          g.appendChild(this._currentDatetime);
        const d = document.createElement("main");
        u.appendChild(d);
        const p = `${vi}-ticks-${vr()}`;
        (this._progressInput = document.createElement("input")),
          this._progressInput.classList.add(vi),
          (this._progressInput.type = "range"),
          (this._progressInput.min = "0"),
          (this._progressInput.max = "" + (n.length - 1)),
          (this._progressInput.step = `${l}`),
          (this._progressInput.valueAsNumber = c),
          this._progressInput.setAttribute("list", p),
          this._progressInput.addEventListener("input", () =>
            this._progressInputClicked()
          ),
          d.appendChild(this._progressInput);
        const h = document.createElement("datalist");
        (h.id = p), d.appendChild(h);
        for (let t = 0; t < n.length; t++) {
          const e = document.createElement("option");
          (e.innerHTML = `${t}`), h.appendChild(e);
        }
        const f = document.createElement("footer");
        u.appendChild(f);
        const m = document.createElement("span");
        m.classList.add(Ii), (m.innerHTML = i(n[0])), f.appendChild(m);
        const C = document.createElement("span");
        C.classList.add(Ei), f.appendChild(C);
        const v = document.createElement("span");
        v.classList.add(yi),
          (v.innerHTML = i(n[n.length - 1])),
          f.appendChild(v);
        const I = document.createElement("a");
        (I.href = "javascript:void(0)"),
          I.classList.add(bi),
          I.classList.add(Bi),
          I.addEventListener("click", () => this.stepBackward()),
          C.appendChild(I);
        const E = document.createElement("a");
        (E.href = "javascript:void(0)"),
          E.classList.add(bi),
          E.classList.add(wi),
          E.addEventListener("click", () => this.start()),
          C.appendChild(E);
        const y = document.createElement("a");
        (y.href = "javascript:void(0)"),
          y.classList.add(bi),
          y.classList.add(Qi),
          y.addEventListener("click", () => this.pause()),
          C.appendChild(y);
        const b = document.createElement("a");
        (b.href = "javascript:void(0)"),
          b.classList.add(bi),
          b.classList.add(xi),
          b.addEventListener("click", () => this.stepForward()),
          C.appendChild(b);
        const B = document.createElement("span");
        B.classList.add(Ti), C.appendChild(B);
        const w = document.createElement("span");
        w.classList.add(Mi),
          B.appendChild(w),
          (this._loaderText = document.createElement("span")),
          this._loaderText.classList.add(Oi),
          B.appendChild(this._loaderText);
      }
    }),
    (t.TooltipControl = class extends Ai {
      constructor(t = {}) {
        super(),
          (this._container = void 0),
          (this._value = void 0),
          (this._direction = void 0),
          (this._directionIcon = void 0),
          (this._directionText = void 0),
          (this._config = t);
      }
      onAdd() {
        return (
          (this._container = document.createElement("div")),
          this._container.classList.add(gi),
          this.setConfig(this._config),
          this._container
        );
      }
      ...
      setConfig(t) {
        if (!this._container) return;
        if (!t.unitFormat) return;
        if (
          this._container.children.length > 0 &&
          this._config.directionType === t.directionType &&
          this._config.directionFormat === t.directionFormat &&
          this._config.unitFormat === t.unitFormat &&
          this._config.followCursor === t.followCursor &&
          this._config.followCursorOffset === t.followCursorOffset &&
          this._config.followCursorPlacement === t.followCursorPlacement
        )
          return;
        (this._config = t), (this._container.innerHTML = "");
      ...
      update(t) {
        if (
          ...
          return;
        const { value: e, direction: n } = t ?? {};
        this._container.classList.toggle(
          "follow-cursor",
          this._config.followCursor ?? !1
        ),
          this._container.setAttribute(
            "data-follow-cursor-placement",
            this._config.followCursorPlacement ?? xe.BOTTOM
          ),
          this._container.classList.toggle("has-value", void 0 !== e),
          this._container.classList.toggle("has-direction", void 0 !== n),
          (this._value.innerHTML =
            void 0 !== e ? u(e, this._config.unitFormat) : ""),
          void 0 !== n
            ? ((this._directionIcon.style.transform = `rotate(${
                (n + 180) % 360
              }deg)`),
              (this._directionText.innerHTML = g(
                n,
                this._config.directionType ?? o.INWARD,
                this._config.directionFormat ?? s.VALUE
              )))
      ...
      updatePickingInfo(t) {
        ...
        if (!t) return void this.update(void 0);
        this.update(t.raster);
        const e = void 0 !== t.raster?.direction,
          n = this._container.firstChild;
        if (this._config.followCursor) {
          const r = n.getBoundingClientRect(),
            a = this._value.getBoundingClientRect(),
            i = this._config.followCursorOffset ?? 16,
            o = this._config.followCursorPlacement ?? xe.BOTTOM;
          let s = t.x,
            A = t.y;
          if (o === xe.BOTTOM) A += i;
          else if (o === xe.TOP) A -= i;
          else if (o === xe.RIGHT) s += i;
          else {
            if (o !== xe.LEFT) throw new Error(`Invalid placement ${o}`);
            s -= i;
          }
          if (
            ((this._container.style.left = `${s}px`),
            (this._container.style.top = `${A}px`),
            o === xe.BOTTOM || o === xe.TOP)
          ) {
            const t = parseFloat(window.getComputedStyle(n).paddingLeft),
              r = parseFloat(
                window.getComputedStyle(this._direction).marginLeft
              ),
              i = -(t + (e ? a.width + r : a.width / 2));
            n.style.left = `${i}px`;
          }
          if (o === xe.RIGHT || o === xe.LEFT) {
            const t = -r.height / 2;
            n.style.top = `${t}px`;
          }
          if (o === xe.TOP) {
          ...
          document.addEventListener("mousedown", () => this.update(void 0), {
            once: !0,
          });
        } else
    ...
    (t.VERSION = "2025.8.0"),
    (t.colorRampCanvas = Qe),
    (t.ensureDefaultProps = v),
    (t.formatDatetime = O),
    (t.formatDirection = g),
    (t.formatUnit = c),
    (t.formatValue = l),
    (t.formatValueWithUnit = u),
    (t.getClosestEndDatetime = function (t, e) {
      return t.find((t) => t >= e);
    }),
    (t.getClosestStartDatetime = function (t, e) {
      return [...t].reverse().find((t) => t <= e);
    }),
    (t.getDatetimeWeight = T),
    (t.getRasterMagnitudeData = function (t, e) {
      const {
          image: n,
          image2: r,
          imageSmoothing: a,
    ...
    (t.getRasterPoints = He),
    (t.interpolateDatetime = x),
    (t.loadJson = Q),
    (t.loadTextureData = w),
    (t.offsetDatetime = M),
    (t.offsetDatetimeRange = function (t, e, n) {
      return [M(t, e), M(t, n)];
    }),
    (t.parsePalette = we),
    (t.setLibrary = function (t, e) {
      i.set(t, e);
    });
});
